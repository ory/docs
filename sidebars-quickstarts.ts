  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        collapsed: true,
        collapsible: true,
        items: ["oss/hydra/index", 
          "oss/hydra/quickstart"],
      },
      {
        type: "category",
        label: "Ory Keto",
      ...
      },
      {
        ...
        collapsed: true,
        collapsible: true,
        items: ["oss/polis/index", 
          "oss/polis/quickstart"],
      },
      {
        type: "category",
        label: "Ory Oathkeeper",
        collapsed: true,
        collapsible: true,
        items: ["oss/oathkeeper/index", 
          "oss/oathkeeper/configure-deploy"],
      },
    ],
  },
]
