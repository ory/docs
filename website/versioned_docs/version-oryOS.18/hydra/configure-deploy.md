...
$ docker run -it --rm --entrypoint hydra oryd/hydra:v1.4.2 help serve
...
```shell
$ docker run --rm -it --entrypoint hydra oryd/hydra:v1.4.2 help
...
```shell
$ docker pull oryd/hydra-login-consent-node:v1.4.2
$ docker run -d \
