...
```sh
$ docker run oryd/oathkeeper:v0.35.5-beta.2 credentials generate --alg RS256 > jwks.json
```
...
```shell
$ cat << EOF > Dockerfile
FROM oryd/oathkeeper:v0.35.5-beta.2
...
```sh
$ docker pull oryd/oathkeeper:v0.35.5-beta.2
```
