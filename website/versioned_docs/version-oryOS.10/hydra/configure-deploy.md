...
```shell
$ docker run --rm -it --entrypoint hydra oryd/hydra:v1.0.0-rc.8 help
```
...
$ docker pull oryd/hydra:v1.0.0-rc.8
...
$ docker run -it --rm --entrypoint hydra oryd/hydra:v1.0.0-rc.8 help serve
...
$ docker run -d \
  ...
  oryd/hydra:v1.0.0-rc.8 serve all
...
```shell
$ docker pull oryd/hydra-login-consent-node:v1.0.0-rc.8
$ docker run -d \
  ...
  oryd/hydra-login-consent-node:v1.0.0-rc.8
