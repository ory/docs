...
>
  ...
  >
          ...
          <tbody>
            <tr>
              ...
              <th>
                ...
                <div>
                  Token URL: https://hydra.demo.ory.sh/oauth2/token
                </div><div>
    ...
    >
      ...
      label={"HTTP: Bearer Auth"}
      value={"oryWorkspaceApiKey"}
    >
      
      
      To use this endpoint you need a workspace-level [Ory Network API key](https://www.ory.com/docs/concepts/personal-access-token).
...
>
  ...
  >
    ...
    API Support: [support@ory.sh](mailto:support@ory.sh)
  </span>
</div><div
