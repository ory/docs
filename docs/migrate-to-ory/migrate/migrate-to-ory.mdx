...
1. Note where identity (authentication and authorization) interacts with other systems (databases, CRMs, partner apps, or external APIs).

At the end of this process you should have a living document with diagrams that capture:

- All identity (authentication and authorization) flows
