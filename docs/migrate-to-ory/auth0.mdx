...
![Image of Auth0 Support Page](_static/1.png)
...
`setting schema this isnt pretty - i know, see https://github.com/ory/docs/pull/1157`
...
Your users are now migrated and can login with their Auth0 credentials 🎉!
