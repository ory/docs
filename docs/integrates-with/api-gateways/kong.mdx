...
description: Validate Ory OAuth2 access tokens and Ory Identities sessions at Kong Gateway using its JWT and session plugins.
sidebar_label: Kong
---
...
[Kong Gateway](https://konghq.com/) is a cloud-native API gateway. There are two integration paths with Ory: JWT validation for
access tokens issued by Ory OAuth2 & OpenID Connect (Hydra), and session validation for Ory Identities (Kratos).
