...
description: Validate Ory Network session tokens and JWTs at the Akamai edge using the EdgeWorkers serverless runtime.
...
[Akamai EdgeWorkers](https://www.akamai.com/products/serverless-computing-edgeworkers) is a V8-isolate serverless runtime. You can
validate Ory Network session tokens and JWTs at the Akamai edge using the same pattern as
