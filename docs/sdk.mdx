...
| JavaScript[^1] | [npmjs.com](https://www.npmjs.com/package/@ory/client)           | [OpenAPI reference index](./sdk/new.mdx) · [README](https://github.com/ory/sdk/blob/master/clients/client/typescript/README.md) |
