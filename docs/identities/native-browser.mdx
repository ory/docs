...
![Architecture for browser-based app integrated with Ory Identities](./_static/browser.svg)
...
![Architecture for a native integrated with Ory Identities](./_static/native.svg)
