...
To use a custom domain as the redirect URL, go to the [OpenID Connect (OIDC)](https://console.ory.sh/projects/current/social-signin) page and click **Show advanced settings**.
