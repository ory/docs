...
To change the limit, go to [**Ory Console**](https://console.orystg.com/) → **Authentication** -> **General** -> **Maximum number of code submissions**, enter the desired number, and click the **Save** button.
