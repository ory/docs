...
Be aware of the added request latency, and of the impact of this service not being available: it will result in an error leading to the user not being considered logged in.
