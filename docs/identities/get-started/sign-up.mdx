...
import tsSignUp from '!!raw-loader!./_common/code-examples/express-ts/sign-up.ts'
import javaSignUp from '!!raw-loader!./_common/code-examples/java/SignUpController.java'
import dotnetSignUp from '!!raw-loader!./_common/code-examples/dotnet/SignUp.cs'
```
...
```mdx-code-block
<CodeBlock language="ts" title={"sign-up.ts"}>{tsSignUp}</CodeBlock>
```
...
```mdx-code-block
<CodeBlock language="java" title={"SignUpController.java"}>{javaSignUp}</CodeBlock>
```
...
```mdx-code-block
<CodeBlock language="csharp" title={"SignUp.cs"}>{dotnetSignUp}</CodeBlock>
```
