...
1. Log in to your [Ory Console](https://console.orystg.com/)
...
<BrowserWindow url="https://console.orystg.com/projects/<id>">
...
<BrowserWindow url="https://console.orystg.com/projects/<id>/social-signin">
