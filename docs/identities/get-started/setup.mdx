...
import javaDevSetup from '!!raw-loader!./_common/code-examples/java/setupDev.java'
import dotnetDevSetup from '!!raw-loader!./_common/code-examples/dotnet/setupDev.cs'
import expressTsDevSetup from '!!raw-loader!./_common/code-examples/express-ts/setupDev.ts'
```
...
```mdx-code-block
<CodeBlock language="ts" title="sdk.ts"> {expressTsDevSetup} </CodeBlock>
```
...
```mdx-code-block
<CodeBlock language="java" title="OryClientFactory.java"> {javaDevSetup} </CodeBlock>
```
...
```mdx-code-block
<CodeBlock language="csharp" title="OryClientFactory.cs"> {dotnetDevSetup} </CodeBlock>
```
