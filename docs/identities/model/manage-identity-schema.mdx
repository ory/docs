...
2. Create a new identity with the updated schema - through the registration interface or [Ory Console](https://console.ory.com/)
...
5. To update the identity, you need to use the [Admin API](../../reference/api#tag/identity/operation/updateIdentity). The API
   requires the Ory Network [Project slug](https://console.ory.com/projects/current/settings),
   [API Key](https://console.ory.com/projects/current/developers), and identity ID. Set them as environment variables:
