...
1. In order to update the identity, you need to use the
...
This should return the modified identity as the response. Now, you have migrated a single identity to a new identity schema. If
you have more identities to be patched to the new schema, repeat the above process for each of them.
