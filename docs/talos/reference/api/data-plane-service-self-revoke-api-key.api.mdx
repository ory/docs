...
<RequestSchema
  {...require("./data-plane-service-self-revoke-api-key.RequestSchema.json")}
></RequestSchema>

<StatusCodes
  {...require("./data-plane-service-self-revoke-api-key.StatusCodes.json")}
></StatusCodes>
