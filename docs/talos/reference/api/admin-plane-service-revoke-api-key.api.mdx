...
<MethodEndpoint
  method={"post"}
  path={"/v2/admin/apiKeys/{key_id}:revoke"}
  context={"endpoint"}
></MethodEndpoint>
...
<ParamsDetails
  {...require("./admin-plane-service-revoke-api-key.ParamsDetails.json")}
></ParamsDetails>

<RequestSchema
  {...require("./admin-plane-service-revoke-api-key.RequestSchema.json")}
></RequestSchema>
