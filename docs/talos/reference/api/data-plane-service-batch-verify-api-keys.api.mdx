...
<RequestSchema {...require("./data-plane-service-batch-verify-api-keys.RequestSchema.json")}></RequestSchema>

<StatusCodes {...require("./data-plane-service-batch-verify-api-keys.StatusCodes.json")}></StatusCodes>
