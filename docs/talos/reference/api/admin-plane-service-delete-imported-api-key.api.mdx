...
<MethodEndpoint
  method={"delete"}
  path={"/v2/admin/importedApiKeys/{key_id}"}
  context={"endpoint"}
></MethodEndpoint>
...
<ParamsDetails
  {...require("./admin-plane-service-delete-imported-api-key.ParamsDetails.json")}
></ParamsDetails>

<RequestSchema
  {...require("./admin-plane-service-delete-imported-api-key.RequestSchema.json")}
></RequestSchema>

<StatusCodes
  {...require("./admin-plane-service-delete-imported-api-key.StatusCodes.json")}
></StatusCodes>
