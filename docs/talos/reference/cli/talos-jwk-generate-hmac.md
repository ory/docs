...
Generate a symmetric HMAC secret key. Default size is 512 bits. Minimum is 256 bits. Key size must be a multiple of 8. Algorithm
is determined by key size: 256→HS256, 384→HS384, ≥512→HS512.
