---
title: Error codes
description: HTTP and gRPC error codes returned by the Ory Talos API
---
...
Ory Talos returns structured error responses following the [herodot](https://github.com/ory/herodot) error format. Every error
...
| `conflict`                    | 409  | `ALREADY_EXISTS`      | The request conflicts with the current state of the resource               |
