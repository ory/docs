...
Setting `Post-OIDC` redirects for Login and Registration are not supported since
an Ory Cloud project can't be setup to use OIDC yet. This will be supported in
the future. For more information see the
