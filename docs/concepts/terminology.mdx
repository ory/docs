...
A generic identifier for each The Ory Network project. It has the format `adjective-name-randomstring` for example:
...
Interfaces and flows in The Ory Network that allow end-users to consume services without the direct involvement of service employees.
