...
This documents' focus is to provide the necessary fundamentals to get started with custom UI integration. Flows are the
...
also seperated into two types of applications - browser and native. The difference between the two is to set the necessary
security measures for the application type.
...
4. Potentially handle flow errors like invalid user input by going back to step 2.
