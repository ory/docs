...
by the _National Cyber Security Centre_ ([`NCSC`](https://www.ncsc.gov.uk/collection/passwords/updating-your-approach)) and
National Institute of Standards and Technology ([`NIST`](https://pages.nist.gov/800-63-3/sp800-63b.html)) as well as
...
- The Ory Network checks all passwords against a database of known leaked passwords through the
