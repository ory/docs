...
```mdx-code-block
<BrowserWindow url="https://console.orystg.com/projects/current/developers">
...
create API Keys in the [Ory Console](https://console.orystg.com/).
...
1. Go to the [Ory Console](https://console.orystg.com/).
...
```mdx-code-block
<BrowserWindow url="https://console.orystg.com/workspaces/current/settings/api-keys">
...
| --------------------------------------------------------------------------------------------------- | ------------------------ | ------------------------------------ |
| Base URL                                                                                            | `api.console.orystg.com` | `$PROJECT_SLUG.projects.oryapis.com` |
