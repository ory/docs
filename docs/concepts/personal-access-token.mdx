...
3. Select **API keys** in the sidebar.2. Click the **+** icon in the **API Keys** section.
...
Workspace API keys are used to authenticated privileged operations on the workspace level, such as creating a new project in a
workspace or adding a new B2B SSO organization to a project within that workspace. Project API keys are used to authenticate
privileged operations on the project level, such as listing identities or creating OAuth2 clients.
