...
For example, when calling Ory administrative APIs to [list](../cli/ory-identities-list.md),
[update](../cli/ory-identities-get.md), or [delete](../cli/ory-identities-delete.md) identities, you must authenticate as an
administrator. You can do that by passing a PAT in the request's `Authorization` header. The PAT must be generated for a user with
administrative rights in the Ory Cloud Project in which you want to manage identities.
