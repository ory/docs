...
For example, when calling Ory administrative APIs to [list](../cli/ory-identities-list.md), [update](../cli/ory-get-identity.md),
...
in the request's `Authorization` header. The PAT must be generated for a user with administrative rights in the Ory Cloud Project
in which you want to manage identities.
