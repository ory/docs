...
Edge Sessions only works with Ory Session Cookies. It does not work with API tokens from native self-service flows or with OAuth2
or OpenID Connect access tokens or ID tokens.
