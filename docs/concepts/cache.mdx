...
You can modify this value in the [Ory Console](https://console.orystg.com/projects/current/authentication/sessions) or using the
Ory CLI (see the [Configuration](#configuration) section).
...
[Ory Console](https://console.orystg.com/projects/current/authentication/sessions).
