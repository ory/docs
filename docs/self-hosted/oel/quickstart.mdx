...
- Ory Oathkeeper Enterprise import ImageTags from "./eol-oathkeeper-image-tags.md"

This is Docker registries available in the EU regions:
`europe-docker.pkg.dev/ory-artifacts/ory-enterprise-oathkeeper/oathkeeper-oel`

import ImageTags from "./eol-oathkeeper-image-tags.md"
