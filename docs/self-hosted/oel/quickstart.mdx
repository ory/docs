...
Support for MySQL and PostgreSQL is available as well, but some features will be unavailable. Please [contact the team](https://www.ory.sh/contact) to talk about your use case.
