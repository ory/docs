...
[database connection string](/docs/oss/deployment) and provide a [configuration file](/docs/hydra/reference/configuration).
...
data:
  dsn: cockroach://
  # https://www.ory.com/docs/hydra/reference/configuration
  secretsCookie:
  secretsSystem:
```
...
## Ory Keto Enterprise License

The Ory Keto Enterprise license includes additional features and support for enterprise customers:

- Regular releases addressing CVEs and security vulnerabilities.

### Ory Keto Docker Registry

This is Docker registries available in the EU region: `europe-docker.pkg.dev/ory-artifacts/ory-enterprise-keto/keto-oel`

import ImageTagsKeto from "./oel-keto-image-tags.md"
