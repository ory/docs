...
:::note All other parameters—such as pod labels, service accounts, and resource configurations—are inherited from your current
Hydra deployment. This minimizes potential configuration discrepancies and reduces the risk of errors. :::
