...
Customizing the token prefix is available to Ory Enterprise License users.
...
For more information or to enable this feature, please [contact Ory Support](https://www.ory.sh/contact). The team is here to assist you
...
documentation, you can configure the token prefix to match your organization's needs.
