...
High-performance pooling is available for CockroachDB and PostgreSQL with an Ory Enterprise License (OEL).
It provides additional configuration options for managing database connections under variable load.
