...
To check if there are newer versions of Ory Oathkeeper OEL, check your Docker or Kubernetes environment
to find the tag you are currently running and compare against this list:
