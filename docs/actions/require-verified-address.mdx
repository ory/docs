...
## Require verification after address change in settings flow

When a user updates their email or phone number, Ory sends a verification code to the new address. You can configure the system to
