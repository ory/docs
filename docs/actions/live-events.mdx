...
- Some events might not emitted at all and be lost. This is deemed to be rare and can only happen in the face of special adverse conditions. In other words, delivery is currently 'best-effort'.
  If 'at-least-once' delivery is required for your use case, please [reach out](https://www.ory.sh/contact/).
