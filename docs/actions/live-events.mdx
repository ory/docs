...
[open a support ticket](https://console.orystg.com/support/).
...
1. Go to your project in the [Ory Console](https://console.orystg.com).
...
```mdx-code-block
<BrowserWindow url="https://console.orystg.com/projects/b3b748e5-7ddc-4860-a672-2436a877dc93/settings/event-streams">
