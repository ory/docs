...
4. Click **Add new Event Stream**.

```mdx-code-block
<BrowserWindow url="https://console.ory.sh/projects/b3b748e5-7ddc-4860-a672-2436a877dc93/developers/event-streams">
  ![Event streams page with the Add new Event Stream button](./_static/live-events/event-streams-empty.png)
</BrowserWindow>
```

5. In the **Add event stream** dialog:
...
```mdx-code-block
<BrowserWindow url="https://console.ory.sh/projects/b3b748e5-7ddc-4860-a672-2436a877dc93/developers/event-streams">
  ![Add event stream dialog with HTTPS type selected](./_static/live-events/event-stream-https-dialog.png)
</BrowserWindow>
```
...
4.  Configure the event stream, replacing the ARNs with those recorded in steps 1 and 2:
    ...
    d. Click **Add new Event Stream**.

    e. In the **Add event stream** dialog:
    ...
    ```mdx-code-block
    <BrowserWindow url="https://console.ory.sh/projects/b3b748e5-7ddc-4860-a672-2436a877dc93/developers/event-streams">
      ![Add event stream dialog with AWS SNS type selected](./_static/live-events/event-stream-sns-dialog.png)
    </BrowserWindow>
    ```
