...
| **GroupDeleted**             | A SCIM group has been deleted. This event will also trigger IdentityUpdated events for all affected users.                                  |
| **GroupUpdated**             | A SCIM group has been updated. Modifying members of a group will also emit IdentityUpdated events for all affected users.                                 |
