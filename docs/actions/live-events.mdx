...
| **RegistrationStarted**     | A new registration flow has been created and basic validation passed.                            |
...
| **LoginStarted**            | A new login flow has been created and basic validation passed.                                   |
