...
| **Event**                    | **Description**                                                                                                                                                                                                      |
| ---------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **GroupCreated**             | A new SCIM group has been created. Includes `ScimClient` attribute.                                                                                                                                                  |
| **GroupDeleted**             | A SCIM group has been deleted. This event will also trigger IdentityUpdated events for all affected users. Includes `ScimClient` attribute.                                                                          |
| **GroupUpdated**             | A SCIM group has been updated. Modifying members of a group will also emit IdentityUpdated events for all affected users. Includes `ScimClient` attribute.                                                           |
...
| **RecoveryInitiatedByAdmin** | An admin has initiated an account recovery on behalf of a user                                                                                                                                                       |
...
| **SettingsSucceeded**        | Changes to account or session settings have been applied.                                                                                                                                                            |
| **VerificationFailed**       | A user's identity verification attempt has failed.                                                                                                                                                                   |
| **VerificationSucceeded**    | A user's identity verification has been completed.                                                                                                                                                                   |
