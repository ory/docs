...
1. In your Ory Network project, set up an Ory Action trigger that will send data to the Segment destination whenever a specific
...
In the following example, we will set up an action which calls
