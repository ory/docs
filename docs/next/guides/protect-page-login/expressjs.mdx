...
In this guide, we set up a new [ExpressJS](https://expressjs.com) application
and protect its home page with a login page using Ory. It will also add features
such as profile settings, registration, and more. You can use this guide with
both Ory Cloud and by self-hosting Ory software.

This guide is for you if you:

1. have [NodeJS](https://nodejs.org/en/) installed;
2. want to use [ExpressJS](https://expressjs.com) to build an application;
...
That however requries that Ory and your application run on the same domain!
...
working with Ory it is important that Ory and your app are available under the
same common domain (e.g. `https://ory.example.com` and
