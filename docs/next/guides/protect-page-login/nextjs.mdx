...
In this guide, we set up a new [Next.js](https://nextjs.org/) application and
protect its home page with a login page using Ory. It will also add features
...
2. want to use [NextJS](https://nextjs.org) to build an application;
