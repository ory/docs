---
id: oauth2-concepts
title: Comprehensive OAuth 2.0 overview
...
## The OAuth 2.0 scope represents user consent
...
access in the name of the user, whereas permissions define what the user themselves are allowed to do. By using scope, users can
control the level of access that clients have to protected resources. But the user has access to "their" resources only, not the
resources (e.g. photos) of another user.
