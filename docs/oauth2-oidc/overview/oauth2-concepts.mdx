...
access to protected resources. To achieve this, the resource server uses the OAuth2 token [introspection endpoint](../../hydra/guides/oauth2-token-introspection.mdx), which is an API
endpoint exposed by Ory.
