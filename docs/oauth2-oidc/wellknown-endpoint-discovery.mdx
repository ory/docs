...
```bash
curl https://$PROJECT_SLUG.projects.oryapis.com/.well-known/oauth-authorization-server | jq
```
...
```json
{
  ...
  "authorization_endpoint": "https://$PROJECT_SLUG.projects.oryapis.com/oauth2/auth",
  "device_authorization_endpoint": "https://$PROJECT_SLUG.projects.oryapis.com/oauth2/device/auth",
  "token_endpoint": "https://$PROJECT_SLUG.projects.oryapis.com/oauth2/token",
  "jwks_uri": "https://$PROJECT_SLUG.projects.oryapis.com/.well-known/jwks.json",
  ...
  "userinfo_endpoint": "https://$PROJECT_SLUG.projects.oryapis.com/userinfo",
  ...
  "revocation_endpoint": "https://$PROJECT_SLUG.projects.oryapis.com/oauth2/revoke",
  "backchannel_logout_supported": true,
  "backchannel_logout_session_supported": true,
  "frontchannel_logout_supported": true,
  "frontchannel_logout_session_supported": true,
  "end_session_endpoint": "https://$PROJECT_SLUG.projects.oryapis.com/oauth2/sessions/logout",
  "request_object_signing_alg_values_supported": ["none", "RS256", "ES256"],
  "code_challenge_methods_supported": ["plain", "S256"],
  "credentials_endpoint_draft_00": "https://$PROJECT_SLUG.projects.oryapis.com/credentials",
...
const response = await fetch("https://$PROJECT_SLUG.projects.oryapis.com.well-known/oauth-authorization-server")
...
```text
https://$PROJECT_SLUG.projects.oryapis.com/.well-known/oauth-authorization-server
```
...
```bash
curl https://$PROJECT_SLUG.projects.oryapis.com/.well-known/openid-configuration | jq
```
...
const ory = await configureSSOProvider("https://$PROJECT_SLUG.projects.oryapis.com")
```
...
```javascript
// Initialize
const client = new OIDCClient("https://$PROJECT_SLUG.projects.oryapis.com", "your-client-id", "https://your-app.com/callback")
...
```text
https://$PROJECT_SLUG.projects.oryapis.com/.well-known/openid-configuration
```
