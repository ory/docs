...
Use this command to patch your current Ory Cloud Project's identity service configuration. Only values specified in the patch will
be overwritten. To replace the config use the `update` command instead.
