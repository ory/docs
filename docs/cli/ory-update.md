...
* [ory update oauth2-config](ory-update-oauth2-config)	 - Update the Ory OAuth2 & OpenID Connect configuration of an Ory Network project.
...
* [ory update permission-config](ory-update-permission-config)	 - Update Ory Permissions configuration of an Ory Network project.
