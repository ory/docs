...
[Here](https://www.ory.com/hydra/docs/reference/api#parameters-27) you can find the Hydra setting and
[here](https://www.ory.com/oathkeeper/docs/v0.37/pipeline/authn/#configuration-5) the respective one for Oathkeeper.
