...
```sh
$ docker run oryd/oathkeeper:v0.16.0-beta.4 credentials generate --alg RS256 > jwks.json
```
...
```shell
$ cat << EOF > Dockerfile
FROM oryd/oathkeeper:v0.16.0-beta.4
...
```sh
$ docker pull oryd/oathkeeper:v0.16.0-beta.4
```
