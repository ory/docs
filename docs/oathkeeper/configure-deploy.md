...
```sh
$ docker run oryd/oathkeeper:v0.17.0-beta.1 credentials generate --alg RS256 > jwks.json
```
...
```shell
$ cat << EOF > Dockerfile
FROM oryd/oathkeeper:v0.17.0-beta.1
...
```sh
$ docker pull oryd/oathkeeper:v0.17.0-beta.1
```
