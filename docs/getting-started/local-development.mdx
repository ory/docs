...
title: Local development for Ory Network
---
...
Copy the project slug from your project's [Connect page](https://console.ory.sh/projects/current/connect) and start the
Ory Tunnel:
...
Running this commands opens the `4000` port on your local machine. This address is connected to your project and its
