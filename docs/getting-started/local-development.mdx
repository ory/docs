...
To create a new staging project, open the [Ory Console](https://console.orystg.com/projects/create), hit "Create new project", and
...
Copy the project slug from your project's [Connect page](https://console.orystg.com/projects/current/connect) and start the Ory
