...
To create a new staging project, open the [Ory Console](https://console.ory.com/projects/create), hit "Create new project", and
...
Copy the project slug from your project's [Connect page](https://console.ory.com/projects/current/connect) and start the Ory
