...
with both Ory Cloud and self-hosted Ory software.
...
The application is also available to download from the [Apple App Store](https://apps.apple.com/pl/app/ory-profile-app/id1536546333).
...
# Clone using HTTPS
https://github.com/ory/kratos-selfservice-ui-react-native.git
```
