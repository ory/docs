...
By default, the application uses the "Playground" project, which is a public demo environment available to all Ory users.
When using the application this way, make sure to anonymize any data you send to Ory!

### Connect to your project

Instead of using the public playground project, you can connect the application directly to your project and its admin
...
With the application live, running, and connected to your project, let's have a closer look at the code to understand
the implementation.
...
[Ory Session Token](../../kratos/session-management/check-session).
