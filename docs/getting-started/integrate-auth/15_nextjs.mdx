...
<CodeBlock language="tsx" title="app/page.tsx">{HomePage}</CodeBlock>
...
Access your Next.js app at [localhost:3000](http://localhost:3000/). Since there is no active session you will be redirected to
the login screen. Then click the link to **Sign up** and create a new account.
