...
```shell-session
ory tunnel --project playground --dev http://localhost:5000
```

![Run Ory Tunnel](../_static/dotnet/ory_tunnel.gif)

3. Open [localhost:5000](http://localhost:5000) to access the application. As the initial call is made by an unauthenticated user,
