...
The `recovery.tsx` file defines the page displayed to user that try to recover their accounts after forgetting a password or losing
access to a second authentication factor.
