...
Ory OAuth2 & OpenID Connect (based on [Ory Hydra](../hydra/index.md)) is available in the Ory Network out of the box. This means
that you can use OIDC, Authorization Code Grant, Client Credentials Grant, and more, without additional configuration or extra
charge.
