...
Ory OAuth2 & OpenID (based on [Ory Hydra](../hydra/index.md)) is available in The Ory Network out of the box, which means you can use
...
By default, The Ory Network uses internal redirect URLs for operations such as user login and consent. You can adjust these URLs to
