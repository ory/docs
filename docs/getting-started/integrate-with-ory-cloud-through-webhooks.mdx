...
Thanks to webhooks, you can easily integrate with external services, for example ERP or CRM. Ory Identity Service (Ory Kratos) allows
...
Follow these steps to add a webhook that enables integration with Mailchimp. With this integration in place, the system sends a welcome
email message to all newly registered users. 
