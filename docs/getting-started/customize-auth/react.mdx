---
id: react
title: Customize authentication in React
sidebar_label: React
---
...
<Teaser
  ...
  mp4={mp4}
  webm={webm}
  sampleUrl={"https://github.com/ory/elements/tree/main/examples/react-spa"}
/>
```
...
Elements simplifies a lof of the frontend development by providing a React component that handles all the logic and user interface
for you.
...
<CodeFromRemote
  lang="json"
  title="package.json"
  src="https://raw.githubusercontent.com/ory/elements/main/examples/react-spa/package.json"
/>
...
This file is used as the main entry point for React. We will use this file to create our routes and add theming to the other pages
in the App.
...
register account and preform login requests.
...
1. Initialize the registration to get the `flow` data on page load
...
1. Initialize the login to get the `flow` data on page load
...
2. Build the React app and run it somewhere (for example on Vercel or Netlify) e.g. `https://example.com`
