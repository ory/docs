...
2. Export environment variable:
   ...
   <Tabs groupId="react-or-preact">
    ...
    ```
    ```bash
    # Here we are using the Ory CLI to connect to Ory Network APIs.
...
<CodeFromRemote
  lang="tsx"
  title="pkg/sdk.tsx"
  src="https://raw.githubusercontent.com/GabeCurran/ory-elements/nextExample/examples/nextjs-spa/pkg/sdk.tsx"
/>
  </TabItem>
</Tabs>
```
...
<CodeFromRemote
  ...
  src="https://raw.githubusercontent.com/GabeCurran/ory-elements/nextExample/examples/nextjs-spa/pages/_app.tsx"
/>
  </TabItem>
</Tabs>
```
...
<CodeFromRemote
  ...
  src="https://raw.githubusercontent.com/GabeCurran/ory-elements/nextExample/examples/nextjs-spa/pages/index.tsx"
/>
  </TabItem>
</Tabs>
```
...
<CodeFromRemote
  ...
  src="https://raw.githubusercontent.com/GabeCurran/ory-elements/nextExample/examples/nextjs-spa/pages/registration.tsx"
/>
  </TabItem>
</Tabs>
```
...
<CodeFromRemote
  ...
  src="https://raw.githubusercontent.com/GabeCurran/ory-elements/nextExample/examples/nextjs-spa/pages/login.tsx"
/>
  </TabItem>
</Tabs>
```
...
<CodeFromRemote
  ...
  src="https://raw.githubusercontent.com/GabeCurran/ory-elements/nextExample/examples/nextjs-spa/pages/settings.tsx"
/>
  </TabItem>
</Tabs>
```
...
<CodeFromRemote
  ...
  src="https://raw.githubusercontent.com/GabeCurran/ory-elements/nextExample/examples/nextjs-spa/pages/verification.tsx"
/>
  </TabItem>
</Tabs>
```
...
<CodeFromRemote
  ...
  src="https://raw.githubusercontent.com/GabeCurran/ory-elements/nextExample/examples/nextjs-spa/pages/recovery.tsx"
/>
  </TabItem>
</Tabs>
```
