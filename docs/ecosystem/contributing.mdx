...
We use [Slack](https://slack.ory.com). You are welcome to drop in and ask questions, discuss bugs and feature requests, talk to
...
and participate in [Slack](https://slack.ory.com) in the #community-call channel.
...
[in our chat](https://slack.ory.com) before getting started to ensure your work is consistent with Ory's roadmap and architecture.
...
feedback, or concerns [please let us know](https://slack.ory.com).
