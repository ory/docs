...
This feature hasn't yet shipped to all projects but we're working on
...
- `panic`: highest level of severity. This event is so rare that it's, with
...
set to `true` you must ensure that the output isn't stored or cached anywhere.
