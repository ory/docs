...
Other Ory components are capable of issuing JSON Web Tokens. Ory's OAuth2 and OpenID Connect Provider (Ory Hydra) is able to
issue OAuth2 Access Tokens in the JSON Web Token format. Using OAuth2 and OpenID Connect is discouraged unless you have a
