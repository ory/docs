...
Although it is an uncommon approach and might require a shift in thinking, Ory has implemented it so that you
don't have to worry about refreshing tokens or deciding whether to store them in `localStorage` or `document.cookies`.

Instead, you can devote all your focus and time to developing great software for your users, while Ory takes care of the complicated heavy lifting by giving
you the best-in-class protection from all common browser attack vectors, such as
...
need to use such complicated protocols at all! We recommend the use of [Ory Hydra](https://github.com/ory/hydra) for
targeted use cases only, such as providing third party integration with your application (e.g. a sign in with [your company] button).
...
Read our extensive blog post exploring [authentication and modern software](https://www.ory.sh/auth-and-modern-software/)
...
This practice was abused for user tracking and targeted advertising. Some browsers deprecated cross-domain cookies, while
