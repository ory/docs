...
cases, check out [Ory OAuth 2.0 and OpenID](https://www.ory.com/hydra) documentation.
...
need to use such complicated protocols at all! We recommend using [Ory OAuth2 & OpenID](https://www.ory.com/hydra) for targeted use
...
You can generate access and refresh tokens using [Ory OAuth2 & OpenID](https://www.ory.com/hydra). We do not recommend using access
