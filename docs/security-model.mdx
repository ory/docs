...
fulfill this requirement, HTTP Cookies are ignored by the browser, which prevents the Ory Identities (Ory Kratos) from
functioning properly.

Ory exposes the APIs at `https://<project-slug>.projects.oryapis.com`. To manage session information, Ory Identities
...
you can self-host or use in Ory Network as the Ory OAuth2 Federation Service.
...
[this issue for the Ory Identities (Kratos)](https://github.com/ory/kratos/issues/2487).
