...
Ory offers an OAuth 2.0 and OpenID Connect solution in the form of Ory OAuth2 & OpenID Connect available in the Ory Network and the
open-source [Ory Hydra Federation Server](https://github.com/ory/hydra), which you can self-host.
...
need to use such complicated protocols at all! We recommend using [Ory OAuth2 & OpenID Connect](https://github.com/ory/hydra) for targeted
use cases only, such as providing third-party integration with your application (for example, in the form of the familiar "Sign in
...
You can generate access and refresh tokens using [Ory OAuth2 & OpenID](https://github.com/ory/hydra). Unless you really need to
use [you need OAuth 2.0 / OpenID Connect](https://www.ory.sh/oauth2-openid-connect-do-you-need-use-cases-examples/), Ory Security
