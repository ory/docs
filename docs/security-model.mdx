...
Ory offers an OAuth 2.0 and OpenID Connect solution in the form of Ory OAuth2 & OpenID available in The Ory Network and the
...
need to use such complicated protocols at all! We recommend using [Ory OAuth2 & OpenID](https://github.com/ory/hydra) for targeted
