...
The new syntax uses `namespace:object` format (e.g., `videos:/cats/2.mp4`). The old syntax `namespace object` (e.g., `videos /cats/2.mp4`) is still supported but deprecated and will show a warning message.
...
The new syntax uses `namespace:object` format (e.g., `videos:/cats/1.mp4`). The old syntax `namespace object` (e.g., `videos /cats/1.mp4`) is still supported but deprecated and will show a warning message.
