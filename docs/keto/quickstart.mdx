...
git clone [git@github.com:ory/keto.git](https://github.com/ory/keto.git) && cd keto

# or use https if ssh cloning gives permission denied error. (Configure ssh keys in github to resolve the issue.) 
git clone [https://github.com/ory/keto.git](https://github.com/ory/keto.git) && cd keto
