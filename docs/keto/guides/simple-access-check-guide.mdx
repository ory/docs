...
using [Ory Kratos](https://www.ory.sh/kratos/docs/) or any other authentication system.
...
that the known cypher messages are stored in Ory Keto and access to the cleartext is encoded by the `decypher` relation.
