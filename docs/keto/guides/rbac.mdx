...
[Ory Permission Language](../../../../docs/keto/reference/ory-permission-language) (OPL) schema.
...
Object IDs in Ory Keto are global — there is no built-in namespacing by tenant or project. Two tuples that reference `Role:admin`
refer to the same object. This applies to any namespace: `Role`, `Organization`, `User`, or any custom namespace you define.
