---
id: upgrade
title: 'Ory Keto Upgrade Guide'
description: 'Seamlessly upgrade your self-hosted Ory Keto instance to the latest version. Our official guide provides detailed instructions, version-specific breaking changes, and best practices for a smooth and secure migration.'
