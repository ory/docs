...
The API is divided into the [read APIs](../concepts/api-overview.mdx#read-apis) and
[write APIs](../concepts/api-overview.mdx#write-apis). Each service is annotated with the API it belongs to.
