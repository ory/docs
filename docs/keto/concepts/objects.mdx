...
for example a file, network port, physical item, ... . It's up to the application to
...
and thus unique identifiers. It's however possible to use for example URLs or opaque
...
internally, for example a UUIDv4 like `61e75133-efff-4281-8148-a1806919f568` or SHA-1
