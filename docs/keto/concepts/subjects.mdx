...
a specific subject (for example user) by some application defined identifier, or a set
of subjects.
...
internally, for example a constant, unique username like `zepatrik` or preferably
