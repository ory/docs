...
Keto could then know the following relationship:
...
subject representing the attributes with the known relationships. Remember that Ory Keto does **not** know how to interpret any
information stored in the relationships. Rather, the application has to preprocess and map the value to the corresponding UUID.
