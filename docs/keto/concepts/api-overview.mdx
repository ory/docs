...
This API allows you to query [relationships](./relation-tuples.mdx) by providing a partial relationship. It can be used to:
...
tree assembles the relationships including the operands as defined in the [namespace configuration](./namespaces.mdx). It can be
used to:
