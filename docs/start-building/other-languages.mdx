...
You can use the Ory Proxy approach outlined in the [Build a Server-Side Web App with Ory](../guides/protect-page-login/index.mdx)
for all server-side and backend / API-only applications. All you need to do is verify the JSON Web Token with the Ory Proxy to see
