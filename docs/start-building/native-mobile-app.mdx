...
Ory Cloud supports native applications, for example browser apps, single page
apps (SPAs), and mobile apps.
...
To get your project's slug, sign in at
[console.ory.sh](https://console.ory.sh/), select **Connect** from the left
navigation panel, and copy the URL from the **SDK Configuration** section. The
slug is the part between `https://` and `projects.oryapis.com`.
...
application! It's licensed as Apache 2.0, which means that you can customize in
accordance with the Ory repo's Apache 2.0 license.
