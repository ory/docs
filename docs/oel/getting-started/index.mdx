...
OpenAI runs Ory Hydra (OEL) to manage authentication for its hundreds of millions of weekly active users — read the
[OpenAI case study](https://www.ory.com/case-studies/openai). DataRobot runs Ory Hydra (OEL) to secure service-to-service
authentication, cutting new-service integration from weeks to minutes — read the
[DataRobot case study](https://www.ory.com/case-studies/datarobot).
...
- **[Ory Actions](https://www.ory.com/docs/kratos/hooks/configure-hooks)** — Hooks that extend Ory by running custom business
  ...
  events.
- **CLIs** — Command-line tools for configuring and operating each self-hosted service.
