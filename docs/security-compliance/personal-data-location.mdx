...
When you [create a new Ory Network project](https://console.ory.com/projects/create) in the Ory Console, you are given a choice of
...
<BrowserWindow url="https://console.ory.com/projects/create">
...
```mdx-code-block
<BrowserWindow url="https://console.ory.com/projects/current/settings">
