...
When you [create a new Ory Network project](https://console.orystg.com/projects/create) in the Ory Console, you are given a choice
of personal data storage location for your new project. Any personal data of your users and identities will be stored just in that
...
<BrowserWindow url="https://console.orystg.com/projects/create">
...
```mdx-code-block
<BrowserWindow url="https://console.orystg.com/projects/current/settings">
