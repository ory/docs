...
<summary> **Authentication & access control for your applications (Ory Kratos & Ory Keto)** </summary>

Users register and sign in through Ory Kratos, while Ory Keto controls what they can see and do based on roles, relationships, or
custom rules. Use this combination when your application needs both identity management and fine-grained permissions.
...
<summary>**Authentication & delegated access across apps and services (Ory Kratos & Ory Hydra)**</summary>

Users authenticate through Ory Kratos, and Ory Hydra issues standards-based OAuth2/OIDC tokens that enable single sign-on and let
...
<summary>**Authentication, SSO, & fine-grained access control (Ory Kratos, Ory Hydra & Ory Keto)**</summary>
...
<summary>**Enterprise SSO with external identity federation (Ory Polis)**</summary>
...
<summary>
  **Authentication, external identity federation, & fine-grained access control (Ory Kratos, Ory Polis, & Ory Keto)**
</summary>

Users authenticate through Ory Kratos or a federated external IdP via Ory Polis, and Ory Keto enforces what they can access. Use
this combination when you need both internal identity management and external federation with granular permissions.
...
<summary>**Ory's full IAM stack (Ory Kratos, Ory Hydra, Ory Keto, Ory Polis, & Ory Oathkeeper)**</summary>
...
(Ory Kratos & Ory Hydra)" example, and presumes the user is already authenticated.
