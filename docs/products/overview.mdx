...
<summary>**Authentication, external identity federation, & fine-grained access control (Ory Kratos, Ory Polis, & Ory Keto)**</summary>

Users authenticate through Ory Kratos or a federated external IdP via Ory Polis, and Ory Keto enforces what they can access. Use this
