...
- The onboarding portal currently supports all well known providers. You can also connect any SAML/OIDC compliant provider using
  the Generic SAML/OIDC IdP option. If you don't find your provider listed, please [contact us](https://www.ory.sh/contact/).

### SCIM support

The onboarding portal also supports SCIM. You can set up a SCIM server for an organization. Guided walkthroughs are available for
