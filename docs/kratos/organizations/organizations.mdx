...
- `pkce` determines whether Ory Identities will use PKCE during the OIDC flow. See the note below and the
  [Configure social sign-in documentation](../social-signin/01_overview.mdx) for details.
...
See the [Configure social sign-in documentation](../social-signin/01_overview.mdx) for details.
