...
In the **Edit Organization** page, under the **Onboarding Portal** section, click **Generate link** to create a link. If a custom
domain is configured for the project, you'll need to choose between the project slug and the custom domain as the base url for the
link. You can then share this link with the organization admins.
