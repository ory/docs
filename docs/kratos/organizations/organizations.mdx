...
```shell
curl -X GET --location "https://api.console.orystg.com/projects/$PROJECT_ID/organizations" \
...
```shell
curl -X POST --location "https://api.console.orystg.com/projects/$PROJECT_ID/organizations" \
     -H "Authorization: Bearer $WORKSPACE_API_KEY" \
...
```shell
curl -X GET --location "https://api.console.orystg.com/projects/$PROJECT_ID/organizations/$ORGANIZATION_ID" \
     -H "Authorization: Bearer $WORKSPACE_API_KEY"
```
...
```shell
curl -X DELETE --location "https://api.console.orystg.com/projects/$PROJECT_ID/organizations/$ORGANIZATION_ID" \
     -H "Authorization: Bearer $WORKSPACE_API_KEY"
```
...
```shell
curl -X PATCH --location "https://api.console.orystg.com/projects/$PROJECT_ID" \
     -H "Authorization: Bearer $WORKSPACE_API_KEY" \
     -H "Content-Type: application/json" \
     -d '[
           {
...
```shell
curl -X GET --location "https://api.console.orystg.com/projects/$PROJECT_ID" \
     -H "Authorization: Bearer $WORKSPACE_API_KEY" \
...
<BrowserWindow url="https://console.orystg.com/projects/<id>/authentication/organizations/<id>/edit">
...
```shell
curl -X POST --location "https://api.console.orystg.com/projects/$PROJECT_ID/organizations/$ORGANIZATION_ID/onboarding-portal-links" \
     -H "Authorization: Bearer $WORKSPACE_API_KEY" \
     -H "Content-Type: application/json" \
     -d '{
...
```shell
curl -X POST --location "https://api.console.orystg.com/projects/$PROJECT_ID/organizations/$ORGANIZATION_ID/onboarding-portal-links/$ONBOARDING_PORTAL_LINK_ID" \
     -H "Authorization: Bearer $WORKSPACE_API_KEY" \
     -H "Content-Type: application/json" \
     -d '{
           "expires_at": "2025-06-01T00:00:00Z",
...
```shell
curl -X DELETE --location "https://api.console.orystg.com/projects/$PROJECT_ID/organizations/$ORGANIZATION_ID/onboarding-portal-links/$ONBOARDING_PORTAL_LINK_ID" \
     -H "Authorization: Bearer $WORKSPACE_API_KEY"
```
...
```shell
curl -X GET --location "https://api.console.orystg.com/projects/$PROJECT_ID/organizations/$ORGANIZATION_ID/onboarding-portal-links" \
     -H "Authorization: Bearer $WORKSPACE_API_KEY"
```
