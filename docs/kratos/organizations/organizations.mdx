...
Onboarding portal is currently in preview and may be subject to changes. Please contact us if you have any questions or feedback.
It also requires Account Experience 2.0 to be enabled for the project.
...
In the edit organization page, in the "Onboarding Portal" section, you can click on "Generate link" to create a link which can be
then shared with the organization admins.
