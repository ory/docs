...
[Landlock filesystem sandbox](../../security-compliance/landlock-sandbox.mdx). If you reference a template stored outside the
override directory, list it under `security.landlock.allowed_paths` or move it inside the override directory.
