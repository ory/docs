...
To set up account recovery, your [identity schema](../manage-identities/identity-schema) must have an email in its traits and add
...
connection configured in your config:
