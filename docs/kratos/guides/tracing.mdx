...
file](https://github.com/ory/kratos/blob/master/quickstart-tracing.yml) in the
project repository has tracing configuration which you can use to play around
with.
...
http://localhost:16686/search. You can now start making requests to Kratos and
inspect traces!
