...
You can provide the oidc configuration using [environment variables](../configuring.md) by setting the environment variable `SELFSERVICE_METHODS_OIDC_CONFIG_PROVIDERS`. For example:
```
