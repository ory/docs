...
1. For authenticating users in a single Azure AD Directory (organization), set
   ...
   page, or the organization domain. E.g. `8eaef023-2b34-4da1-9baa-8bc8c9d6a490`
...
application. To prevent this you can add a random suffix (e.g. a number) to the
...
> configuration. There is no way to login through them without linking if e.g.
> emails match.
