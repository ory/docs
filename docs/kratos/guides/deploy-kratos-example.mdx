...
`/etc/systemd/system/` with the following content (change `https://accounts.example.com` to your domain!):
...
- Fork the [Ory Kratos NodeJS UI Reference](https://github.com/ory/kratos-selfservice-ui-node) or [build a custom UI in the language of your choice](https://ory.sh/docs/kratos/sdk).
