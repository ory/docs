...
mv kratos-selfservice-ui-node-${useLatestRelease('kratos')}/ ui
cd ui
npm i
...
+      ui_url: https://accounts.vinckr.com/auth/registration
      after:
        password:
          hooks:
            -
...
- Fork the
  [Ory Kratos NodeJS UI Reference](https://github.com/ory/kratos-selfservice-ui-node)
  or
  [build a custom UI in the language of your choice](https://ory.sh/docs/kratos/sdk).
- [Add Two Factor Authentication (2FA) to your App](https://www.ory.sh/docs/kratos/guides/two-factor-authentication-2fa-mfa)
- [Configure The Password Policy](https://www.ory.sh/docs/kratos/guides/password-policy)
- [Integrate using Web-Hooks](ory.sh/docs/kratos/guides/integration-with-other-systems-using-web-hooks)
