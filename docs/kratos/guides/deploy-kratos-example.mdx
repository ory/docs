...
[spin up a custom interface in your favorite language](https://www.ory.sh/docs/kratos/sdk/01_index.md) - this is just an example!
...
- [Add Two Factor Authentication (2FA) to your App](../mfa/overview)
- [Configure The Password Policy](./password-policy.mdx)
- [Integrate using webhooks](./integration-with-other-systems-using-web-hooks.md)
