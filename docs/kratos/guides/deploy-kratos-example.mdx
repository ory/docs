...
reverse proxy, [Digital Ocean](https://www.digitalocean.com/) as cloud provider, and the Ory Kratos Node.js UI Reference as user
...
- Installation and configuration of [Ory Kratos Node.js UI Reference](https://github.com/ory/kratos-selfservice-ui-node)
