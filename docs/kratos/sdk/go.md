...
```
## Making requests
The most helpful example for this example would be toSession call. Because Go is mostly used on backend systems and you need to check session and use it in your middlewares or API endpoints.
