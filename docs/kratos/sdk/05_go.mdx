...
- [client-go (for Ory Network)](https://github.com/ory/client-go/tree/master/docs)
- [kratos-client (for selfhosted Ory Kratos)](https://github.com/ory/kratos-client-go/tree/master/docs)
