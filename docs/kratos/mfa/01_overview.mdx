...
user self-service, such as updating account information or an email address, against malicious actors.
...
manager which is responsible for generating these codes. Read more on [Time-based one-time passwords (TOTP)](./15_totp.mdx).
