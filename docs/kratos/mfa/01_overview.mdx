...
[FreeOTP](https://freeotp.github.io/) and enter them when asked to provide their second authentication factor. Read
[Time-based one-time passwords (TOTP)](./15_totp.mdx) to learn more.
