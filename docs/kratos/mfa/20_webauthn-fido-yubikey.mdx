...
- USB, NFC, or Bluetooth Low Energy devices, for example a [YubiKey](https://www.yubico.com/why-yubico/how-the-yubikey-works/)
...
- Implementing WebAuthn in your own UI can be challenging. Check out the
  [reference implementations](../../kratos/guides/custom-ui.mdx) to see how you can approach implementation for different app
  types (web app, SPA).
...
1. Sign in to the **Ory Console** and go to [**Two-Factor Authentication**](https://console.ory.sh/projects/current/mfa).
