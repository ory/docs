...
- [ ] Access identity schema information (for example usernames) within the
      jsonnet mapper ([kratos#987](https://github.com/ory/kratos/issues/987))
...
- [x] Add option for disabling registration
      ...
      [@hackerman](https://github.com/aeneasr)
- [x] Password policies: make api.pwnedpasswords.com configurable
