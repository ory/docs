...
[OpenID Connect and OAuth2 Method](../../guides/social-signin/overview) support
[Jsonnet](https://jsonnet.org), allowing you to write code that modifies your
identity's data and load it into Ory Kratos.
