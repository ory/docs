...
[Landlock sandbox](../../security-compliance/landlock-sandbox.mdx). Jsonnet code can transform claims and produce
identity traits, but it cannot read files from disk under any circumstances.
