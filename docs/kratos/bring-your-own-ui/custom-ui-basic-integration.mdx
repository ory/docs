...
[`/self-service/registration/browser`](../reference/api#tag/frontend/operation/createBrowserRecoveryFlow) endpoint. When creating a registration flow for **native applications** you must use the [`/self-service/registration/api`](../reference/api#tag/frontend/operation/createNativeRecoveryFlow) endpoint.
