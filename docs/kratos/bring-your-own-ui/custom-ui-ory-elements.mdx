...
- [Install Ory CLI](../guides/cli/01_installation.mdx) - a tool that will help you connect the app running on your machine to Ory
  Network APIs.
...
edit your project's [Identity Schema](../kratos/manage-identities/05_identity-schema.mdx) or try changing adjusting project
settings and enable [passwordless](../kratos/passwordless/01_webauthn.mdx) flows.
...
To learn more about the self-service login flow, read [this document](../kratos/self-service/flows/user-login.mdx)
