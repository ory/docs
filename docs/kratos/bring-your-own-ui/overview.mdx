...
for you to cater to your user's needs and have full control of the user experience. The best way to start is by using the provided
Ory examples and tooling, since this will shorten the time to market and allow you to focus on your application business logic.
...
`login`, `registration`, `settings`, `verification` and `recovery` for you. Ory Elements is designed to leave the business logic
up to you. This means you decide how you would like to handle API calls to Ory and how that state of the data is managed within
your application.

To get started with Ory Elements, take a look at the [Custom UI with Ory Elements](./custom-ui-ory-elements) guide.

## What are the next steps?

To understand the fundamentals of the Ory APIs and how to interact with them, take a look at the
