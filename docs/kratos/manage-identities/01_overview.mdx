...
Ory Identity Service (Ory Kratos) uses identities to identify entities that sign up or authenticate. These can be humans that sign
up on a website or an application that uses Ory, for example online store customers, file sharing service users, or company
