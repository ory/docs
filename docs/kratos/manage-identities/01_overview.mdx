...
Identities in Ory are humans that sign up on a website or an application that uses Ory, for example online store customers, file
sharing service users, or company contractors signing up to use internal systems.
