...
public metadata are also searchable. Use the Status (`Active`/`Inactive`), Identity Schema, Organization, and Registration date
facets to narrow down your search results.
