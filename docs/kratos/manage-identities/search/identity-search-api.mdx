...
Advanced identity search via the API is available in preview on the Ory Network enterprise plan.
[Get in touch](https://www.ory.sh/contact/) for more information.

:::

Advanced identity search allows you to perform full-text search on identity traits, metadata (public+admin), combined with
