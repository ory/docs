...
The identity schema defines personal fields for first name, last name, nickname, and age, and includes two checkboxes: one
required for accepting the terms of service and one optional for newsletter subscription. :::note
