...
Ory Network provides three basic Identity Schema presets.
...
You can configure Ory Identities (Ory Kratos) to use specific fields as the identity's identifier. In this example, the
