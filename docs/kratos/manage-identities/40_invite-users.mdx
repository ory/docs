...
If your application must be accessible only to specific individuals, or you want to allow only specific people to register in your
application instead of making registration publicly available, you can send invitations to selected users.
