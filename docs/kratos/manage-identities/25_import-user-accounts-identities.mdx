...
If your system doesn't have a `subject` ID, you can use the email address as the subject. This isn't recommended, as the email
...
[automatic account linking on import documentation](../social-signin/95_account-linking-on-import.mdx#automatic-account-linking).
