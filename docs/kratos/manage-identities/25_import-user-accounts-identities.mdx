...
2.  Configure a password migration web hook
    ...
    a. Go to your project in the [Ory Console](https://console.orystg.com).
    ...
    ```mdx-code-block
    <BrowserWindow url="https://console.orystg.com/projects/b3b748e5-7ddc-4860-a672-2436a877dc93/developers/actions">
...
3.  Implement the password migration web hook
    ...
    ```mdx-code-block
    <BrowserWindow url="https://console.orystg.com/projects/b3b748e5-7ddc-4860-a672-2436a877dc93/identities/2db9fa1c-95fd-4112-bdbc-a4bd857d7426">
...
If issues persist, contact [support](https://console.orystg.com/support).
