...
[API reference](https://www.ory.sh/docs/reference/api#tag/identity/operation/batchPatchIdentities). If you
need to import more identities, split the import into multiple requests.
