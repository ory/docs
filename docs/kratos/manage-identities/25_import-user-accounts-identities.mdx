...
2.  Configure a password migration web hook
    ...
    <BrowserWindow url="https://console.ory.sh/projects/b3b748e5-7ddc-4860-a672-2436a877dc93/developers/actions">
      ![Action Base Details dialog with Password Migration flow selected](.../_static/manage-identities/import-user-accounts-identities/1.png)
    </BrowserWindow>
    ```
    ...
    ```mdx-code-block
    <BrowserWindow url="https://console.ory.sh/projects/b3b748e5-7ddc-4860-a672-2436a877dc93/developers/actions">
      ![Action authentication dialog](.../_static/manage-identities/import-user-accounts-identities/2.png)
    </BrowserWindow>
    ```
    ...
    ```mdx-code-block
    <BrowserWindow url="https://console.ory.sh/projects/b3b748e5-7ddc-4860-a672-2436a877dc93/developers/actions">
      ![Actions & Webhooks page showing the Password Migration action](.../_static/manage-identities/import-user-accounts-identities/3.png)
    </BrowserWindow>
    ```
...
3.  Implement the password migration web hook
    ...
    <BrowserWindow url="https://console.ory.sh/projects/b3b748e5-7ddc-4860-a672-2436a877dc93/identities/2db9fa1c-95fd-4112-bdbc-a4bd857d7426">
      ![Identity detail page showing the Migration pending badge](.../_static/manage-identities/import-user-accounts-identities/4.png)
    </BrowserWindow>
    ```
