...
When you set the account recovery method to `code`, the system uses these templates:

- `recovery_code.valid`: Sent if the user provided a recovery address that belongs to a registered account.
- `recovery_code.invalid`: Sent if the user provided an address that doesn't belong to a known account.

When you set the account recovery method to `link`, the system uses these templates:
...
When you set the account verification method to `code`, the system uses these templates:
...
When you set the account verification method to `link`, the system uses these templates:
