...
Ory Identities uses the following email templates to fulfill account recovery requests, if the chosen account recovery strategy is
"Code":
...
If Ory Identities is configured to use the "Magic Link" strategy to fulfill account recovery requests, the following templates are
used instead:
...
Ory Identities uses the following email templates to fulfill address verification requests, if the chosen strategy is "Code":
...
If Ory Identities is configured to use the "Code" strategy to fulfill address verification requests, the following templates are
used instead:
