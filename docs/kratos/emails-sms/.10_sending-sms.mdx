...
# TODO: Update this doc, once the Ory Network support sending SMS
---

:::info

The Ory Network currently does not support sending SMS. However, we are working on making it available soon.
