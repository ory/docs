---
id: check-session
title: Check for user sessions in browser cookies and session tokens
sidebar_label: Check for sessions
---
...
To check for sessions of API clients, call the `/sessions/whoami` and include the Ory Session Token as the Bearer Token in the
