...
<TabItem value="self-service-listing-sessions-native" label="Native">
...
<TabItem value="self-service-revoke-session-native" label="Native">
...
<TabItem value="self-service-revoke-other-sessions-native" label="Native">
