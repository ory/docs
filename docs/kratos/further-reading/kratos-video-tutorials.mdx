...
This part can actually take minutes, but once the output has slowed down
...
But oh look, there is an error already since this password isn't actually
secure but has been found in more than 200 data leaks, so this is some basic
security that's already set up in your SecureApp.
...
If you are unsure where your kratos directory is (in my case it's my Git
