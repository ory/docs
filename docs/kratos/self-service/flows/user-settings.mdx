...
- `profile` for updating an identity's traits (for example change the first name). The updated traits must be valid against the
  Identity Schema defined for its [Identity Traits](../../../guides/manage-identities/managing-users-identities-metadata).
...
The form fields depend on the [Identity Schema](../../../guides/manage-identities/identity-schema).
