...
Ory Network offers a default UI for all self-service flows. Visit the
[Bring Your Own UI](https://www.ory.sh/docs/kratos/bring-your-own-ui/01_overview.mdx) document for more info on a custom UI.
