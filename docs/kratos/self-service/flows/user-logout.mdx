...
The logout URL is valid for the duration of the session. This means that you can call the endpoint once and cache this URL for
some time before you call the endpoint again.
...
You can set the default return URL after a logout using the [Ory CLI](../../../guides/cli/01_installation.mdx):

```shell
ory patch identity-config {project-id} \
   --replace '/selfservice/flows/logout/after/default_browser_return_url="https://example.org"'
```
