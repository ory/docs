...
[privileged session](../../session-management/session-lifespan#privileged-sessions) and are taken to their account's settings page
where they must create a new password to regain access to their account.
