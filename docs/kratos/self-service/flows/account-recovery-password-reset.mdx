...
### Notifying unknown addresses

Ory Identities can send a notification email, if recovery was requested for an address that does not belong to any known account.
