...
reset their password in the app without opening a browser. However, this flow is only available for the `code` method.
...
Go to **Project settings** → **Advanced** and enable **Native Recovery Flows** in the
[Ory Console](https://console.ory.sh/projects/current/recovery).
