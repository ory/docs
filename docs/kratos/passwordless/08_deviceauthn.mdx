...
<!--
Mermaid source mirror (the real source is the base64 inside the image URL below).
Parens used instead of braces because MDX parses curly braces as JSX expressions inside HTML comments.
