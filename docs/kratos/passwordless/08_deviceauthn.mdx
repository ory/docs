...
And for macOS (the same approach works on iOS):
  ...
  override func applicationDidFinishLaunching(_ notification: Notification) {
    ...
    channel.setMethodCallHandler { (call: FlutterMethodCall, result: @escaping FlutterResult) in
      if call.method == "generateResidentKey" {
        ...
        // Call the native API here, for the example we simply get the macOS version.
...
And the Flutter code gets this result back: `macOS version: Version 26.2 (Build 25C56)` (for example).
