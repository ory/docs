...
as a complete passwordless first factor — see [Device authentication with PIN and biometrics](09_deviceauthn-pin.mdx).
...
- With `first_factor` enabled, a key protected by an app PIN or platform biometrics is a complete passwordless login granting AAL2
  — see [Device authentication with PIN and biometrics](09_deviceauthn-pin.mdx).
...
1. This guide covers the second-factor setup: the UI should only show existing Device Binding keys and related buttons (e.g. to
   ...
   login, see [Device authentication with PIN and biometrics](09_deviceauthn-pin.mdx).
...
[Device authentication with PIN and biometrics](09_deviceauthn-pin.mdx).
