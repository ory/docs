...
for `127.0.0.1` and `localhost` which are both separate TLDs. Make sure that you
use `127.0.0.1` or `localhost` consistently across your configuration!
...
NodeJS, ...) make sure to include the `Cookie` header from the client when
