...
The subject ID of a user is different in each app registration. The object ID of the user can therefore be used to identify a user
independently of the app registration in which the user has registered.
