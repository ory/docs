...
Your project can enforce AAL2 through <SameDeploymentLink to="kratos/mfa/step-up-authentication">step-up
authentication</SameDeploymentLink>. When a user signs in through a social sign-in provider that already enforces multi-factor
