...
6. The following **Scopes** are available once **Sign In with LinkedInV2** has been activated:
    - `r_emailaddress`
    - `r_liteprofile`
8. On the **Auth** page, copy the **Client Secret** field.
8. Copy the **Client Secret** from the registered application in LinkedIn to the **Client Secret** field in the Ory Console.
9. Copy the **Client ID** from the registered application in LinkedIn to the **Client ID** field in the form in the Ory Console.
