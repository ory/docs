...
This section covers how to implement social sign-in for native applications via OIDC and OAuth 2.0. The user interaction looks
like this:
...
### Native app social sign-in authentication flow
...
`http://localhost:19006/Callback`. Please ensure that this redirect URL is allowed. Go
