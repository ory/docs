...
2. If your SDK supports nonce validation, make sure to use a generated value and submit that during this step.
...
Make sure to request the scopes you require in your Jsonnet mapping, as otherwise they will be empty after the registration.
...
As Ory does not communicate directly with Google during this flow, it does not have access to the Access & Refresh Tokens. This
means that Ory cannot return these in the admin APIs or SDK.
