...
See the [Advanced Integration](../bring-your-own-ui/10_custom-ui-advanced-integration.mdx#upstream-provider-parameters) document
for more information on passing parameters from your UI to Ory.
