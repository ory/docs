...
Automatic account linking was previously not available in Ory. It has been recently added and is now enabled on the Ory Network as
well as on the open-source master branch.
