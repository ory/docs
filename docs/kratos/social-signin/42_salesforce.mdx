...
7. Create the app.
8. Go to the **OAuth Settings** of your newly created connected app, click on **Manage Consumer Details** and copy the following
...
9. Copy the Salesforce top-level domain from the URL bar (typically `https://mySalesforceTenant.my.salesforce.com`) to the
