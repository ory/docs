...
It's also possible to redirect someone back to the original URL. For example,
if a user requests `https://www.myapp.com/blog/write` but isn't logged in, we
...
This feature is in prototype phase and will be documented at a later
stage.
