...
attack surface, the likelihood, and impact of an attack.
...
There is no universally accepted standard to digital identity.  
...
for exanple login and registration endpoints.
...
CAPTCHA measures to ensure the security of the network. For guidelines how this can be implemented for each flow please check the
[concept documentation for self-service flows](https://www.ory.sh/docs/kratos/self-service).
