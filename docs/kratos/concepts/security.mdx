...
populated with your currently configured [Custom Domains](https://www.ory.sh/docs/guides/custom-domains). If your domain list
exceeds this limit, you won't be able to enable CAPTCHA protection.
