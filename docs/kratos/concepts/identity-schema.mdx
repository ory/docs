...
An inactive identity won't be able to log into the system. It will receive a
...
the identity itself for example as part of the registration or profile update process
...
The Identity Schema isn't a place to store sensitive information that should
...
There are no other extensions supported for Identity Traits. Further
fields will be added in future releases!

## Best Practices for Updating Identity Schemas

We strongly encourage everyone to specify unique (for example versioned) identifiers
...
Weeks later you might notice that you want some additional fields, or want
