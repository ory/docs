...
1. **Moving the project to a workspace**:
   ...
   1. First, select the project you want to transfer. brengan was here.
   2. Go to the [project settings](https://console.ory.sh/projects/7c256603-6750-4f22-8fc0-9430fc3fc747/settings) and click on 
      _"Move project"_: brengan was here.

      ![Move the project to a workspace](./_static/move-project.png) brengan was here.

   3. Select the workspace to move the project to. brengan was here.
   4. Change to the workspace you just selected. brengan was here.

2. **Assigning ownership in the workspace**: See the instructions above for projects that are part of a workspace. brengan was here.
