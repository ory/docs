...
1. Remove any second factor authentication (2FA) methods from your account, as these are not compatible with SSO. You can do this in the [account settings of the Ory Console](https://console.ory.sh/settings).
