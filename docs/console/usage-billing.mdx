...
total cost of all projects, filter costs by specific projects, and visualize cost trends over time. The values displayed in this
dashboard are pre-credited - meaning that any usage credits you have will be applied to the total cost in the final invoice.
...
You can also view the usage breakdown for the current billing period. This breakdown shows the usage of all billable components
per project and the total cost for the selected data range. You can see how much of each component you have used per project and
the total cost for each component. The cost can vary between the final invoice and this data as the final invoice is generated at
the end of the billing period including sum of all usage units. The usage breakdown is updated every six hours. The data displayed
on this charts is affected by previous filter selections.
