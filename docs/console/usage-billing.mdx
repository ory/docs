...
[advanced settings page](https://console.ory.sh/settings/advanced) and enable the `Show invoices` feature. You should now see the
usage-based invoices sidebar entry in the workspace settings page.
