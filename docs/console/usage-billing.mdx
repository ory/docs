...
Usage-based invoices are a new feature in the Ory Console that allows you to understand your usage of Ory Network services, the
usage that is included in your plan, and the overuse. Usage-based invoices are generated every month.
