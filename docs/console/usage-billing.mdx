...
[advanced settings page](https://console.ory.sh/settings/advanced) and enable the **Workspace invoice overview** feature. You should
now see the usage-based invoices sidebar entry in the workspace settings page.
