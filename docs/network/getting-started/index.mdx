...
[The Ory Network](https://console.orystg.com/) uses cloud-native open-source technologies (Kubernetes, Crossplane, Cockroach,
Linux, Ory) and standards (OAuth 2.0/2.1, OpenID Connect, MITREid, WebAuthn, TOTP, FIDO3) to deliver a low-latency, planet-scale
...
Core infrastructure components of [Ory Network](https://console.orystg.com) are open source to foster collaboration, reduce supply
...
In short: Ory Network is the most convenient way to run Ory. [Sign up](https://console.orystg.com/registration) and create a free
developer project.
