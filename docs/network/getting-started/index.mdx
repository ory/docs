...
[Ory Actions](/docs/kratos/hooks/01_configure-hooks.mdx) provide a flexible way to extend the capabilities of the Ory Network by defining
...
Head over to the [Ory Open Source Overview](/docs/oss/open-source.mdx) for an introduction to the different projects.
