...
Ory provides pre-built binaries, Docker Images and support various package
managers:
...
[k8s.ory.sh/helm](https://k8s.ory.sh/helm/).
...
<p>
  ...
  page. No installer is available. You have to add the binary to the PATH in your
  environment yourself, for example by putting it into
