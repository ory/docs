...
Logged webhook events are retained for 7 days by default. Use the
[`DSYNC_WEBHOOK_LOGS_TTL`](../deploy/env-variables.mdx#dsync_webhook_logs_ttl) environment variable to change the retention period
or to keep events indefinitely.
