...
id: ory-proxy
title: ory proxy
description: ory proxy Easily protect applications with the Ory Proxy
---
...
- [ory proxy production](ory-proxy-production) - Run an application in
  production mode with Ory integration
