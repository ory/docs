...
Our identity management, based on the open source [Ory Kratos](https://www.ory.sh/kratos) project implements everything
related to identities (users):
...
- **Headless APIs and data models** allow you to fully customize identity models (e.g. adding fields like first name, accept tos, shipping address, gender, ...)
and create your own login, registration, profile settings, recovery, and verification screen using our easy to use SDKs and REST APIs.

## Open Source

Many of our building blocks are open source. Below you find a list of all open source resources. Also check out
the sidebar for our open source documentation.
