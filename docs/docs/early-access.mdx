...
The Ory Platform (our new SaaS offering) is currently in early access and invite-only. We are using
our hardened and proven open source stack (e.g. Ory Kratos), but some things are yet to be done:

1. All data in the dashboard is synthetic.
2. Personal Access Tokens are an interim solution for accessing our APIs. We will be migrating
to mTLS and OAuth2 flows where applicable in the future.
