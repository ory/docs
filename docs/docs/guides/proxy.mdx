...
If you run get an error while working with the Ory Proxy or Ory CLI , make sure you are on the
latest version. 
- For [brew (MacOs)](https://www.ory.sh/docs/start-building/ory-cli-install-use#install-on-macos) use `brew upgrade ory`,
- For [scoop (Win)](https://www.ory.sh/docs/start-building/ory-cli-install-use#install-on-windows) use `scoop update ory` 

to update to the latest version.
The Ory CLI will autoupdate in the near future.