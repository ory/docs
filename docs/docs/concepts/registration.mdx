...
Ory offers two main methods of Registration:
...
Currently only the `password` registration method is supported. The `oidc` method will be added soon.  
...
<!-- @UPDATE! The response needs to be updated! -->
...
```yaml 
ui_url: http://$ORY_PROJECT_PUBLIC_API/self-service/registration
--> http://$ORY_PROJECT_PUBLIC_API/self-service/registration?flow=df607aa1-d555-4b2a-b3e4-0f5a1d2fe6f3
...
To begin the API Registration Flow, the client calls the API-flow initialization
...
$ curl -H "Accept: application/json" -s \
  'https://$ORY_PROJECT_SLUG/api/kratos/public/self-service/registration/flows?id=a43dfd74-e80c-4e39-896e-1743f1fa3c67' | jq
  
{
  ...
  "request_url": "https://$ORY_PROJECT_SLUG/api/kratos/public/self-service/registration/browser",
  "ui": {
    "action": "https://$ORY_PROJECT_SLUG/api/kratos/public/self-service/registration?flow=a43dfd74-e80c-4e39-896e-1743f1fa3c67",
    "method": "POST",
    "nodes": [
      {
        "type": "input",
...
Ory Managed UI - Registration Screen:
<img alt="Ory Managed UI" src={('./code/registration/images/browser.png')}/>
...
prevent Account Enumeration Attacks. Do not enable sign in after registration, if Account Enumeration is a concern for your application. 
...
#### With Automatic Sign In on Registration
...
Set-Cookie: ory_kratos_session=MTYyMjgyMjk1NHxEdi1CQkFFQ180SUFBUkFCRUFBQVJfLUNBQUVHYzNSeWFXNW5EQThBRFhObGMzTnBiMjVmZEc5clpXNEdjM1J5YVc1bkRDSUFJSGhJYmtaUk5VOUxPWEpTVERsTVlXMVpRWFZZYVVRMVJrbHROMDVuUW05bHwjas7DFWPYno-3WNlTR9RrPalTbKMt5eMIEajPptX2pQ== ; Path=/; Expires=Fri, 04 Sep 2020 21:32:47 GMT; Max-Age=86400; HttpOnly; SameSite=Lax
Vary: Cookie
Date: Thu, 05 Jun 2021 16:09:14 GMT
Content-Length: 0
```
...
curl -s -H "Cookie: ory_kratos_session=MTU5OTE2ODc2N3xEdi1CQkFFQ180SUFBUkFCRUFBQVJfLUNBQUVHYzNSeWFXNW5EQThBRFhObGMzTnBiMjVmZEc5clpXNEdjM1J5YVc1bkRDSUFJR055VlROMGRteHhSakJrUzBkbmRUUjBlVFY1V0RCRWFVTnJXVmR6V25oaHx2DICsB6IMbaHSQwnYITUZqr7Qx7CxUlnaneJWH495wQ==" \
  $ORY_PROJECT_SLUG/api/kratos/public/sessions/whoami | jq

{
  "id": "65fb29ac-2b2a-46bc-9917-3170de736db7",
  "active": true,
  "expires_at": "2021-06-05T16:09:14.506915Z",
  "authenticated_at": "2021-06-04T16:09:14.551912Z",
  "issued_at": "2021-06-04T16:09:14.50694Z",
  "identity": {
    "id": "670300e4-ea3d-4466-8dda-05758e14873a",
    "schema_id": "default",
    "schema_url": "$ORY_PROJECT_SLUG/api/kratos/public/schemas/default",
    "traits": {
      "email": "foouser@ory.sh"
    },
    "verifiable_addresses": [
      {
        "id": "5d6a7034-328a-4a3d-ab65-12359619ada3",
        "value": "foouser@ory.sh",
        "verified": false,
        "via": "email",
        "status": "sent",
        "verified_at": null,
        "created_at": "2021-06-04T16:09:14.477086Z",
        "updated_at": "2021-06-04T16:09:14.477086Z"
      }
    ],
    "recovery_addresses": [
      {
        "id": "2d9b9669-e989-4109-9f92-d82e9b0e98d8",
        "value": "foouser@ory.sh",
        "via": "email",
        "created_at": "2021-06-04T16:09:14.48149Z",
        "updated_at": "2021-06-04T16:09:14.48149Z"
      }
    ],
    "created_at": "2021-06-04T16:09:14.472103Z",
    "updated_at": "2021-06-04T16:09:14.472103Z"
  }
}
```
