...
Enable sign in after registration disables account enumeration defeneses!
...
<table>
  <thead>
  <tr>
    <th><img alt="Integrate Ory with NodeJS" width={100} src={useBaseUrl("images/get-started/nodejs.png")}/></th>
    <th />
  </tr>
  </thead>
  <tbody>
