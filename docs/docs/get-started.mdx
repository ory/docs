---
id: get-started
title: Get Started with Ory Cloud
sidebar_label: Get Started with Ory Cloud
---

Ory Cloud is currently in [early access](./early-access.mdx) and invite-only. We
are giving away one year for free for startups that want to migrate to Ory
Cloud.

**Limited seats available, apply today at
[console.ory.sh](https://console.ory.sh/registration).**
...
As we are building Ory Cloud as a scalable, managed way to run Ory for you. User
feedback and constructive exchange with you is most important to us. Your
feedback and guidance during the free year of using Ory Cloud will help us build
the best identity platform.

In an Early Access system, not everything is completely finished. With your
help, we will get there faster and better!

We want to give back to our open source community and let you experience the
vision we have for Ory Cloud firsthand. It will make clear that a commercial Ory
service will help our open source ecosystem grow and thrive, and work in its
interest.
...
Access. Please reach out to support@ory.sh if you have any questions.
