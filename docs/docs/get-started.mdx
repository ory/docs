...
schema, allowing you to separate between different customer types, user types
(e.g. employees and customers).

[Learn more about the Identity Schema](concepts/identity.mdx) and the available
...
![Choose Identity Schema for Ory project](./images/get-started/project-create-identity-model.png)
