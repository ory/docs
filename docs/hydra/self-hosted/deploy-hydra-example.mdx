...
[relational database](/docs/oss/deployment#data-storage-and-persistence), a different reverse proxy, deploy on any other cloud
host, and [spin up a custom user interface in your favorite language](../sdk/overview) - this is just an example!
...
- [Add Identity and Account Management](/docs/oel/kratos/intro)
