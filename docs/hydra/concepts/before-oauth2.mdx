...
["Do you need OAuth2?"](https://www.ory.sh/oauth2-openid-connect-do-you-need-use-cases-examples/). For a more in-depth understanding
of when to use OAuth2 and OpenID Connect, as well as more examples of use cases, we recommend checking out our blog post.
