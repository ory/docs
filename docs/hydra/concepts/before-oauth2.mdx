...
which is why you probably ended up at Ory OAuth2 & OpenID. But before you start hacking away, the best use of your time right now
...
your user's data, Ory OAuth2 & OpenID is the right tool for you.
...
in with Google", "Sign in with Apple"), Ory OAuth2 & OpenID is the right tool for you.
...
- Ory OAuth2 & OpenID maintains a session cookie. When a user signs in, the cookie will be set for that user. This allows the next
...
2. you are reaffirmed that you need OAuth2 and OpenID connect because you want developers you don't know to interact with your
   users and your users' data - in which case Ory OAuth2 & OpenID is a great fit for you!
