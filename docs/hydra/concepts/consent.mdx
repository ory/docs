...
and consent flow to another app - we call this the Login & Consent App.
...
![OAuth 2.0 Asking for User Consent](../_static/google-consent-playground.png)

The UI is fully under your control, because Ory OAuth2 & OpenID Connect redirects the End-User's browser to the "Consent Endpoint"
...
Ory OAuth2 & OpenID Connect appends a `consent_challenge` query parameter to the url. The value is a ID which should later be used
...
![Exemplary OAuth 2.0 Consent Screen](../_static/consent-endpoint.png)
...
Check the ["Implementing the Consent Endpoint" Guide](../guides/consent.mdx) for examples using the Ory OAuth2 & OpenID Connect
