...
In this example we did not define a value for the optional setting `URLS_ERROR`.
...
`error` and `error_description` parameters. If this value is not set, Hydra uses
