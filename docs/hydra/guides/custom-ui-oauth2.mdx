...
- Create an account and project in the Ory Network. Use [Ory CLI](../../guides/cli/cli-basics.mdx#create-a-new-workspace-and-project)
  or go to the [Ory Console](https://console.ory.sh/).
