---
id: custom-ui-oauth2
title: Use your custom UI when running OAuth2 flows in Ory Network
sidebar_label: Custom UI with OAuth2
---

# Custom UI with OAuth2 flows
...
This is a protected endpoint, which means that you must include the Ory PAT in the `Authorization` header of the request.
...
[client created in The Ory Network](#create-oauth2-client-in-the-ory-network):
