...
## Enabling graceful refresh token rotation
...
## Disabling graceful refresh token rotation
...
## Configuration in self-hosted deployments (Ory Enterprise License / DIY)

For self-hosted deployments, you can configure graceful refresh token rotation in your configuration file:
