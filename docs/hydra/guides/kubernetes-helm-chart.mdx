...
To install Ory Hydra, the following [configuration values](../reference/configuration.md) must be set:
...
You can pass your [Ory Hydra configuration file](../reference/configuration.md) by creating a yaml file with key `hydra.config`
