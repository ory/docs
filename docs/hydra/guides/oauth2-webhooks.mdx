...
Ory Hydra will perform a POST request with a JSON payload towards your endpoint.
...
`session` represents the OAuth session, along with the data that was passed to the
