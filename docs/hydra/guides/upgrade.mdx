...
Visit the [CHANGELOG.md](https://github.com/ory/hydra/blob/master/CHANGELOG.md) to see if breaking changes have been introduced in the version you are upgrading to.
1. Backup your data.
