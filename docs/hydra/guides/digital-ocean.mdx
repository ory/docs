...
```
Important notes of the configuration

We expose Hydra's public endpoints to the public internet without additional authentication/authorization. However, Hydra has additional administrative endpoints that can be used to implement a management interface to manage data. These endpoints and the whole admin service are used either for internal usage (e.g., /health endpoints to check availability of Hydra) or to manage data (add/update/remove clients or keys)
