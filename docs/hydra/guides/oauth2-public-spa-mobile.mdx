...
You can create a public OAuth 2.0 Client (for example for the authorize code +
PKCE or implicit flow) with the CLI
...
public OAuth 2.0 Client, you can't authenticate with the HTTP Basic
...
The public clients using a non-https redirect scheme can't skip consent as per
OpenID Specification & Certification.
