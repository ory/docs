...
This guide will help you configure the token expiration time for various tokens in Ory, including the user login and consent flow,
access tokens, ID tokens, auth codes, and refresh tokens.
...
example, if you want the auth code to last for five minutes, you can set the config as follows:
