...
The OAuth 2.0 specification ([RFC 6749, Section 3.1.2.2](https://datatracker.ietf.org/doc/html/rfc6749#section-3.1.2.2)) requires exact URI matching. On shared platforms such as Heroku, Vercel, and Netlify, wildcard subdomains would allow any tenant on that platform to intercept authorization codes or tokens intended for your application.
