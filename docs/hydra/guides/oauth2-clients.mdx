---
id: oauth2-clients
title: Manage OAuth 2.0 & OpendID Connect clients
...
2. Click on **Add New Client** and complete the form or update an existing client.
...
Head over to the [API documentation](../../reference/api#tag/oAuth2/operation/createOAuth2Client).
...
3. When done making changes, scroll to the top and click the **Save** button.
...
Head over to the [API documentation](../../reference/api#tag/oAuth2/operation/setOAuth2Client).
...
Head over to the [API documentation](../../reference/api#tag/oAuth2/operation/patchOAuth2Client).
...
2. Locate the client you want to update.
3. Click on **pen symbol** to update the client's configuration.
3. Scroll to the buttom and click **delete client**.
...
Head over to the [API documentation](../../reference/api#tag/oAuth2/operation/deleteOAuth2Client).
...
Use the SDK or REST API to register an OAuth2 & OpenID Connect client:
...
Head over to the [API documentation](../../reference/api#tag/oAuth2/operation/createOidcDynamicClient).
...
Head over to the [API documentation](../../reference/api#tag/oAuth2/operation/getOidcDynamicClient).

</TabItem>
</Tabs>
````

### Update OAuth2 & OpenID Connect clients
...
Head over to the [API documentation](../../reference/api#tag/oAuth2/operation/setOidcDynamicClient).
...
Head over to the [API documentation](../../reference/api#tag/oAuth2/operation/deleteOidcDynamicClient).
