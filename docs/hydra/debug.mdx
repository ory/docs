---
id: debug
title: OAuth2 first aid
sidebar_label: Solutions for common OAuth2-related problems
---
...
If you need more information in response for debugging, switch the project to development mode.
