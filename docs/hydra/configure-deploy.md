...
$ docker run -it --rm --entrypoint hydra oryd/hydra:v1.1.1 help serve
...
```shell
$ docker run --rm -it --entrypoint hydra oryd/hydra:v1.1.1 help
...
```shell
$ docker pull oryd/hydra-login-consent-node:v1.1.1
$ docker run -d \
  ...
  oryd/hydra-login-consent-node:v1.1.1
