...
If no active authentication session is set at Ory OAuth2 & OpenID Connect, the browser will be redirected immediately to the system-wide configured
...
Before filing a bug report, make sure you have a cookie named `oauth2_authentication_session` for the URL Ory OAuth2 & OpenID Connect is
