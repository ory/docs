---
id: hydra-update-client
title: hydra update client
description: hydra update client Update an OAuth 2.0 Client
---
...
```
  ...
  -c, --redirect-uri strings                            List of allowed OAuth2 Redirect URIs.
