...
Ory SDKs are generated using the [openapi-generator](https://github.com/OpenAPITools/openapi-generator). The Ory Hydra Go SDK is
generated using [`go-swagger`](http://goswagger.io).
