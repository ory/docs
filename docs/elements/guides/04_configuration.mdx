...
- [OryClientConfiguration](../reference/@ory/elements-react/core/interfaces/OryClientConfiguration.md)
...
In development environments, if neither is set, Ory Elemetns tries to "guess" the base URL by looking at the current origin of the
page.
