---
id: next-pages-router-quickstart
title: Pages Router Quickstart
sidebar_label: Pages Router Quickstart
---
...
[Component Custimization](../guides/01_customization.mdx) for more details on how to customize the components.
