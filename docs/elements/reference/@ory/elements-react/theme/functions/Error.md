...
| `props.error`       | \| \{ `correlationId?`: `string`; \} & `FlowError` \| \{ `correlationId?`: `string`; \} & \{ `error`: `string`; `error_description`: `string`; \} \| \{ `correlationId?`: `string`; \} & \{ `error`: `GenericError`; \}                                                                                                                                                                                                                         | The error object returned by the Ory SDK. This can be a FlowError, OAuth2Error, or a GenericError.                                            |
