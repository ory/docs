...
To use Ory Network on one or more domains that you own, you can set a CNAME record.
...
`auth.foobar.ory` set as our custom domain which will point to your project. It is important that you add CORS origins
...
Once active, the Ory Account Experience is reachable at `https://<your-custom-domain>/ui/welcome`. Learn how to configure a custom UI:
