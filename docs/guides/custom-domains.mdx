...
The domain you enter in the first step will be the domain that you'll use for requests to The Ory Network. You will have to create a
...
UI: [Bring Your Own UI](bring-your-user-interface.mdx).
