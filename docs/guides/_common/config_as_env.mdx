...
When running a self-hosted instance, you can pass the social sign-in provider configuration 
in the `SELFSERVICE_METHODS_OIDC_CONFIG_PROVIDERS` [environment variable](../../kratos/configuring). For example: 
