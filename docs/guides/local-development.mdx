...
The easiest way to achieve that is by using the [Ory Tunnel](cli/20_proxy-and-tunnel.mdx). Ory Tunnel is a tool that is a part of
the [Ory CLI](cli/01_installation.mdx).
