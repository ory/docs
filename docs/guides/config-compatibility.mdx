...
Ory CLI is actively developed. This means that new configuration options are added with new CLI 
releases. 
...
Let's look at an example. If you want to change the name of the email sender for recover and verification emails, 
create a configuration file which looks like this: 
...
the name of the email sender for recover and verification emails, run this command:
