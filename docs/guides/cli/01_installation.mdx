...
Ory CLI is a convenient and easy-to-use tool that helps you manage and configure Ory Network and self-hosted projects.
...
The ability to export configurations allows you to bring your setup from a self-hosted environment to the cloud and from Ory Network
