...
Using the Ory CLI, you can quickly adjust the configuration of Ory Permissions and apply config from the Ory Network
environment to self-hosted Ory Keto instances.

:::tip

Ory Keto is the open-source project that powers the Ory Permissions.
...
To work with the Ory Permissions, you must have an active project. Use the
...
To start using the configuration from a self-hosted Ory Keto instance in the Ory Permissions, import the
