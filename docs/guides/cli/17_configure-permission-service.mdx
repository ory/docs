...
To work with the Ory Permissions, you must have an active project. Use the [CLI](./config-with-cli.mdx) or the
...
You must be signed in to an Ory Network account to perform this action. Read [this document](./cli-basics.mdx) to learn more.
