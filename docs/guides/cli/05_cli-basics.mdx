...
2. If you haven't signed in with the CLI before, you're asked if you have an Ory Cloud account.
...
Optional: Use the `--name` flag to specify the project name, for example `ory create project --name 'My Amazing Project'`.
...
3. Follow the on-screen instructions to sign in to your account.
   ...
   If you created your Ory Cloud account with a social sign-in provider, you must adjust the account configuration to use the CLI.
   [Read this section for more information](#accounts-with-social-sign-in).

   :::

4. Upon successful sign in, the CLI shows the details of the signed-in user and the selected Ory Cloud project:
