...
Visit the [Reference](../../cli/ory-auth) section to view all commands, flags, and options available in the Ory CLI.
This documentation is generated automatically from the CLI source code. 
...
4. When the process is completed, the CLI displays the details of the created
   account and the ID of the currently selected project:
...
By default, no projects are associated with new accounts created through the Ory
CLI. To create a new project, use the [CLI](#create-ory-cloud-project) or the
