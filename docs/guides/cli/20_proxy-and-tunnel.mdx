...
it works in a similar way. There are, however, several important differences between these tools: 
  ...
  ❌ Ory Tunnel doesn't handle traffic routing
  ❌ Ory Tunnel doesn't mirror Ory URLs and as such doesn't add the `.ory` prefix to any of the Ory URLs
  ...
  and doesn't use JWTs natively <br />
