...
The main use case for Ory Tunnel and Ory Proxy is local development, and should not be used in production. You can use Ory Tunnel
in the same way you use Ory Proxy. Read about the [differences](#differences-between-ory-tunnel-and-ory-proxy) between the two at
