...
To work with the Ory Identities, you must have an active project. Use the
...
To start using the configuration from a self-hosted Ory Kratos instance in Ory Identities, import the
