...
There are several reference implementations and guides available for building your
own login, registration, ... user interface and forms on top of Ory's APIs:
