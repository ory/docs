...
> Note: The number of projects allowed in each environment depends on your specific subscription or enterprise contract. Please
> check the [Pricing page](https://www.ory.sh/pricing/) for details.
