...
the following command to convert a file to base64:
...
new identity schema to base64 and add it to the config file. You can use the following command to convert a file to base64:

```bash
base64 < identity-schema.json
```
