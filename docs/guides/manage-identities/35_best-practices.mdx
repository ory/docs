---
id: best-practices
title: Follow these best practices to create secure and functional accounts for your users
...
Read [this document](./managing-users-identities-metadata) for information how to use metadata that can't be viewed or changed by the end
user.
