...
Your Ory Cloud account isn't limited to a single project. You can create as
...
(for example deleting an identity, using the Ory CLI, ...). Personal Access Tokens are
bound to a project.
