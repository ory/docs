...
To change it to Lax and allow users to sign in or access user settings without
authenticating with the second factor, go to the **Ory Cloud Console →
Two-Factor Authentication** and use the switches in the **General Settings**
section.
...
change the enforcement model by adjusting these keys in the configuration file:
