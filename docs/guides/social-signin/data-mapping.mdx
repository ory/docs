...
information consistently, the payload isn't standarized.
...
Ory Identity Service (Kratos) adds an external variable called `claims` to the data mapper. It contains all claims for the OpenID
