...
This feature enables log in using any Azure Active Directory account including multi-tenant and personal Microsoft accounts, for example Skype, and
Xbox, depending on the settings used when creating the application in Azure AD.
