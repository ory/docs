...
To increase the security, you can choose to encode the tokens with AES or XChaCha20 Poly1305 ciphers.
Read [this document](../../kratos/guides/select-cipher-algorithm) to learn how to choose the cipher.