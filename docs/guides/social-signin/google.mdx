...
6. Go to [Credentials](https://console.cloud.google.com/apis/credentials) and create a new
   [OAuth client ID](https://console.cloud.google.com/apis/credentials/oauthclient). :::info
...
Cloud Console. 8. Save the configuration and copy the Client ID and Client secret. 9. Paste the Client ID and Client secret of the
