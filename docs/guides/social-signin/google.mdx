...
9. Paste the Client ID and Client secret of the
created OAuth client into the corresponding fields in the Ory Cloud Console.  
...
To define the mapping, create a Jsonnet code snippet. Read [this document](./data-mapping) to learn more about Jsonnet data mapping.
