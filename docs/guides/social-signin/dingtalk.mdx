...
Follow these steps to add DingTalk as a social sign-in provider to your Ory
...
3. Create a Jsonnet code snippet to map the desired claims to the Ory Identity
   ...
   [DingTalk's User API](https://open.dingtalk.com/document/orgapp-server/dingtalk-retrieve-user-information)
   can be viewed.
...
Follow these steps to add DingTalk as a social sign-in provider when
