...
Follow these steps to add Discord as a social sign-in provider to your Ory Cloud
...
and adds the data to `std.extVar('claims')`. Not all fields are supported. Check
...
Follow these steps to add Discord as a social sign-in provider when self-hosting
Ory Kratos:
