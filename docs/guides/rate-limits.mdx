...
Ory Network currently enforces the following threet rate limit policies based on the path of your request. The rate limit values
which get enforced are dependent on the subscription tier of your project.
