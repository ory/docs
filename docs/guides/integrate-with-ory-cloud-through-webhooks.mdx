...
title: Use webhooks to integrate with Ory Network
sidebar_label: Webhooks
---

Thanks to webhooks, you can easily integrate with external services, for example ERP or CRM. Ory Identities (Ory Kratos)
...
Read [this document](../kratos/hooks/configure-hooks) to learn more about hooks in Ory Network.
