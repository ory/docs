...
The Ory Network dashboard offers a simple and intuitive tool to manage your Actions.

Follow the steps below:

1. Navigate to [Ory Network > Developers > Actions](https://console.ory.sh/projects/current/developers/actions). There, click on **+ Create new Action**.
...
3. Click on **Next**. The ensuing screen allows you to establish authentication parameters and input additional request body details. To learn more about tailoring your request body, see the relevant section below.
4. Once all settings have been adjusted, click on **Save action**. Your new action should now be created and ready to operate.
