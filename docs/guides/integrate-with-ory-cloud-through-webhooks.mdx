...
1. Navigate to [Ory Network > Developers > Actions](https://console.ory.sh/projects/current/developers/actions). There, click on
   **+ Create new Action**.
...
3. Click on **Next**. The ensuing screen allows you to establish authentication parameters and input additional request body
   details. To learn more about tailoring your request body, see the relevant section below.
