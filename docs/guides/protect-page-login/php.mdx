...
import mp4 from './php/screencast.mp4'
import webm from './php/screencast.webm'
...
To access the PHP app through the ORY proxy open [http://localhost:4000](http://localhost:4000) in your browser. You
are presented with Ory's Sign In page! Let's click on sign up and create your first user!
