...
4. Open [http://localhost:4000](http://localhost:4000) to access the
   ...
   <br /> <br /> From there, you can create a new account or sign in using an
   existing identity. When you sign in, the session becomes valid and the
   application shows the `Dashboard` page with the session data.
