...
Then open [http://localhost:4000](http://localhost:4000) in your browser. You are presented with Ory's Sign In page! Let's click on sign up and create your first user!
