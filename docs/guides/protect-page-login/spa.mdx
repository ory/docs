---
id: spa
title: Single Page App + API
sidebar_position: 1
---

In this guide we will walk through setting up Ory with a Single Page App. We will use VueJS as the frontend framework, but the
concepts shown can be applied to any single page app framework (React, Angular, ...).

```mdx-code-block
import mp4 from '../_static/spa/screencast.mp4'
import webm from '../_static/spa/screencast.webm'
import VideoEmbed from '@site/src/components/VideoEmbed'

<VideoEmbed mp4={mp4} webm={webm} />
```

## Create Single Page VueJS App

We create a new VueJS project
...
The last step is to run the app. Open a new terminal window, run
