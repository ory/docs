...
Ory supports custom Identity Schemas. To learn more about the concept of Identity Models at Ory, please head over to
[Identity Schema, Custom Fields](../concepts/identity.mdx). The Identity Model is a JSON Schema which describes the traits that
make up an identity, for example customers, users or staff accounts.
