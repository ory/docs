...
- Press `Enter` or hit the `Update` button to save it, once you have made your
  changes. Currently, it isn't possible to edit an existing Identity Schema on
...
While it's currently not possible to directly edit existing Identity Schemas,
