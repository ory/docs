...
The Ory Permission Service ([Keto](https://github.com/ory/keto)) is based on Google Zanzibar. It might differ a bit from
...
Learn the dedicated documents to learn more about [subjects](/keto/concepts/subjects.mdx) and [objects](/keto/concepts/objects.mdx).
...
Assuming the previously defined relation tuples are stored in the system, one could ask:
