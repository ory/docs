...
Ory Permissions is available to all Ory Network users without additional fees or setup. The API is in a production-ready state.
The documentation, integration, and UI are under active development.
