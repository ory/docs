...
![Custom Domain Cors disabled](../../keto/_static/opl_editor.png)
...
Next, connect to the Ory Network using the Ory CLI. If you haven't done so already, [install the Ory CLI](../cli/installation).

Next, in a shell:

```shell
# Log in with your Ory Network credentials
ory auth
...
# Output:
#   ID                                      SLUG                            STATE   NAME
#   1e5ff8a6-b374-41a0-9f96-bcfe022b0a0a    laughing-lederberg-58dlr9kvp7   running Ory Permissions Test

# Use the project ID to set the project where you added the permission rules.
ory use project 1e5ff8a6-b374-41a0-9f96-bcfe022b0a0a
# Output:
#   ID      1e5ff8a6-b374-41a0-9f96-bcfe022b0a0a
```

Now the Ory CLI is configured to use your Ory Network project.
...
To learn more about the Ory Permission Language, read the [specification](../../keto/reference/ory-permission-language) document.
