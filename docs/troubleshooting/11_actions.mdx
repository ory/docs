...
To debug this issue, [export the Ory Identities configuration](../guides/cli/identity-cli) and check the order of the actions. The
`session` hook should be the last one to run.
