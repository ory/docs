...
This problem affects Ory Cloud projects created before September 2022 that use a custom domain. For newly added social sign-in
providers, social sign-in flows can fail with the following message:
...
[Ory Cloud Console social sign-in configuration screen](https://console.ory.sh/projects/current/social-signin) and copy the
