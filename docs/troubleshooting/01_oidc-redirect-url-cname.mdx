...
Please note that with new project's a different step is required to fix this problem. See the
[Troubleshooting Social Sign-in](./troubleshooting-social-sign-in) guide for more information.
