...
# Contribute to Ory Documentation<!-- omit in toc -->
...
or the [Ory Chat](https://slack.ory.com).
...
- **Help with open issues.** We have a lot of open issues for Ory Documentation and
...
the core team via a GitHub issue or [in our chat](https://slack.ory.com)
