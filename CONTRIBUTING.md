...
# Contributing to Ory Documentation
...
won't clash or be obviated by Ory Documentation's normal direction. A great way
to do this is via
[Ory Documentation Discussions](https://github.com/ory/meta/discussions) or the
[Ory Chat](https://www.ory.sh/chat).

## FAQ

- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](https://github.com/ory/docs/blob/master/CODE_OF_CONDUCT.md)

- I have a question. Where can I get
  [answers to questions regarding Ory Documentation?](#communication)
...
- I want to talk to other Ory Documentation users.
  [How can I become a part of the community?](#communication)

- I would like to know what I am agreeing to when I contribute to Ory
  Documentation. Does Ory have
...
[list of good first issues](https://github.com/ory/docs/labels/good%20first%20issue).
...
- **Give us a star.** It may not seem like much, but it really makes a
  ...
  Documentation. Github stars help the project gain visibility and stand out.
...
- **Helping with open issues.** We have a lot of open issues for Ory
  Documentation and some of them may lack necessary information, some are
...
Check out
[Ory Documentation Discussions](https://github.com/ory/meta/discussions). This
...
Documentation's roadmap and architecture.
...
1. Ensure that each commit has a descriptive prefix. This ensures a uniform
   ...
   [list of prefixes for Documentation](https://github.com/ory/docs/blob/master/.github/semantic.yml)
   for an overview.
...
[docs](https://github.com/ory/docs/tree/master/docs) folder. Generate API and
...
- Private harassment is also unacceptable. No matter who you are, if you feel
  ...
  Documentation core team immediately.
