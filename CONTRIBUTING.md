...
- I have a question. Where can I get [answers to questions regarding Ory Documentation?](#communication)
...
- **Give us a star.** It may not seem like much, but it really makes a difference. This is something that everyone can do to help
  out Ory Documentation. Github stars help the project gain visibility and stand out.
...
1. Ensure that each commit has a descriptive prefix. This ensures a uniform commit history and helps structure the changelog.  
   Please refer to this [list of prefixes for Documentation](https://github.com/ory/docs/blob/master/.github/semantic.yml) for an
   overview.
...
5. have signed our [Contributor License Agreement](https://cla-assistant.io/ory/docs);
...
[docs](https://github.com/ory/docs/tree/master/docs) folder. Generate API and configuration reference documentation using
`cd docs; npm run gen`.
...
- Private harassment is also unacceptable. No matter who you are, if you feel you have been or are being harassed or made
  uncomfortable by a community member, please contact one of the channel ops or a member of the Ory Documentation core team
  immediately.
