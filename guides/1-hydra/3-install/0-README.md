...
$ docker run -it --rm --entrypoint hydra oryd/hydra-preview:latest help serve
...
$ docker run -d \
  ...
  oryd/hydra-preview:latest serve
...
```
$ docker run --rm -it --entrypoint hydra oryd/hydra-preview:latest help
