...
$ docker pull oryd/hydra:v1.0.0-beta.3
...
$ docker run -it --rm --entrypoint hydra oryd/hydra:v1.0.0-beta.3 help serve
...
$ docker run -d \
  ...
  oryd/hydra:v1.0.0-beta.3 serve
...
```
$ docker run --rm -it --entrypoint hydra oryd/hydra:v1.0.0-beta.3 help
