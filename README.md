...
Documentation for the individual projects lives in their respective `docs`
...
To format all documentation relevant files simply run the following command from the repositories the main directory:
...
- Introduction
    - The purpose of this category is to introduce the very `basics` of the project and give newcomers an easy way to start. Contains the most basic explanation of the project, and installation guide, a Quickstart/5-Minute Tutorial, and Contribution Guidelines.
- Concepts
...
- Guides
    - The purpose of this category is to solve a specific problem. It has the form of a `series of steps` towards a goal. It is aimed at more experienced users, who are already familiar with the concepts and tools.
- Reference
