...
- Headings play an important role in SEO and searchability, and make the
  document more scannable. Make your headings short and true to the content they
  introduce.
...
After recording the video, convert the `.mov` file `mp4` and `webm`:
