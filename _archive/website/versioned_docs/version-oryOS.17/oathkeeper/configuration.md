  ...
  api:
    ...
    cors:
      ...
      allowed_headers:
        - incid
        - id officia
        - minim irure labore dolore
        - elit incididunt cillum reprehenderit labor
        - reprehenderit esse
  ...
  proxy:
    ...
    cors:
      ...
      allowed_headers:
        ...
        - velit
        - laboris
        - nulla ut voluptate et
        - dolore qui id aute eu
...
authenticators:
  ...
  oauth2_client_credentials:
    ...
    config:
      ...
      #
      required_scope:
        - anim nulla dolore veniam
        - in incididunt ut tempor dolore
