        ...
        <div className="main">
            ...
            {!session ? (
                <div>
                    ...
                    <li>
                        <a href={`${basePath}/ui/registration`} data-testid="sign-up" id="sign-up">Sign Up</a>
                    </li>
                </div>
            ) : (
                <>
                    <h3>Calling <code>toSession()</code></h3>
                    <div className="long">
                        <p>
                            Use the SDK's <code>toSession()</code> call to receive the session
                            information, for example the authentication methods used:
                        </p>
                        <pre><code data-testid='ory-response'>{JSON.stringify(session.identity?.traits, null, 2)}</code></pre>
                    </div>
                    ...
                    {apiResponse && (
                        <>
                            ...
                            <div className="long">
                                ...
                                <pre><code data-testid='api-response'>{JSON.stringify(apiResponse, null, 2)}</code></pre>
                            </div>
                        </>
                    )}
                    {/* highlight-end */}
