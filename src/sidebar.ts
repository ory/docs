...
const guides = (flat: boolean): ExtendSidebar => {
  const items = []
  if (!flat) {
    items.push(homeLink)
  }
...
const localDevelopment = [homeLink, "getting-started/local-development"]
