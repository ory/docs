...
// These sidebars are generated by docusaurus-plugin-openapi-docs.
// Use require with fallback so the build doesn't fail when they don't exist yet
// (e.g. on first CI run before gen-api-docs has run).
