...
export const content = [
  ...
  { name: "Customize Self-service UI: NodeJs", language: "typescript", framework: "NodeJs", link: "https://github.com/ory/kratos-selfservice-ui-node", description: "A reference implementation for Ory Kratos' in NodeJS / ExpressJS / Handlebars / NextJS.", createdby: "Ory", tested: true}, 
  { name: "Customize Self-service UI: NextJS", language: "typescript", framework: "NextJs", link: "https://github.com/ory/kratos-nextjs-react-example", description: " Add login, registration, account recovery (password reset), account verification (email verification), social sign in, multi-factor authentication to your Next.js / React App using Ory!", createdby: "Ory", tested: true}, 
  { name: "Customize Self-service UI: Vue3", language: "javascript", framework: "Vue3", link: "https://github.com/timalanfarrow/kratos-selfservice-ui-vue3-typescript", description: "A reference self-service UI implementation for Ory Kratos' in Vue.", createdby: 'timalanfarrow', tested: false}, 
  { name: "Customize Self-service UI: Erlang", language: "erlang", framework: "Rebar3", link: "https://github.com/hrefhref/styx", description: "Lightweight self-service UI for Ory Kratos/Hydra", createdby: 'hrefhref', tested: false},
  { name: "Customize Self-service UI: Rescript", language: "rescript", framework: "React", link: "https://github.com/allancalix/kratos-ui", description: "A ReScript React implementation of Kratos browser authentication flows.", createdby: "Ory", tested: true}, 
  { name: "Customize Self-service UI: React Native", language: "typescript", framework: "React Native", link: "https://github.com/ory/kratos-selfservice-ui-react-native", description: " A reference implementation of an app using ORY Kratos for auth (login), sign up (registration), profile settings (update password), MFA/2FA, account recovery (password reset), and more for React Native. ", createdby: "Ory", tested: true}, 
  { name: "Customize Self-service UI: Sveltekit", language: "javascript", framework: "Sveltekit", link: "https://github.com/micleyman/sveltekit-ory-starter", description: "An unstyled starter template for a modern Svelte Kit app, secured using Ory's open source libraries.", createdby: "micleyman", tested: true}, 
  { name: "Customize Self-service UI: Sveltekit", language: "javascript", framework: "Sveltekit", link: "https://github.com/drejohnson/sveltekit-kratos", description: "Basic SvelteKit example using Ory Kratos for authentication.", createdby: "drejohnson", tested: false}, 
  { name: "Customize Self-service UI: Sveltekit", language: "javascript", framework: "Sveltekit", link: "https://github.com/emrahcom/kratos-selfservice-svelte-node", description: "Self-service Svelte node for Ory Kratos. It has no style or decoration. Apply your custom style according to your application.", createdby: "emrahcom", tested: false}, 
  { name: "Customize Self-service UI: Flutter", language: "dart", framework: "Flutter", link: "https://github.com/amorevino/ory-showcase-apps", description: "Flutter app using ORY Kratos for authentication.", createdby: "amorevino", tested: false}, 
