    ...
    cards: [
        {
            ...
            description: "Enable and customize email, username, or phone-based password login",
            language: "auth",
        ...
        },
        {
            ...
            description: "Allow secure login using biometric authentication (fingerprint, face) with industry-standard WebAuthn support",
        ...
        },
        {
            ...
            description: "Implement a simple two-step verification process with one-time codes sent to users' email or phone",
            language: "otp",
        ...
        },
        {
            ...
            description: "Email verification, phone verification, and account activation",
            language: "verify",
...
export const authorizationSecurity: {
    ...
    cards: [
        ...
        },
        {
            ...
            description: "Group users by organization and support corporate SSO with SAML and OIDC providers",
        ...
        {
            title: "Secure APIs",
            description: "Protect your backend services with token-based authentication",
            language: "api",
...
export const backendFrameworks: {
    ...
    cards: [
        ...
        },
        {
            ...
            description: "Integrate Ory authentication and permissions with your Python application",
            language: "python",
...
export const deploymentOptions: {
    ...
    cards: [
        ...
        {
            title: "Open source",
            description: "Ory is open source first. Run Ory on your own infrastructure.",
            language: "github",
