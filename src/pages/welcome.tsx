      ...
      <div className="container">
        ...
        >
          ...
          >
            ...
            <p
              style={{ fontSize: "1.25rem", marginTop: 0, textAlign: "center" }}
            >
        ...
        <div style={{ textAlign: "center", marginBottom: "2rem" }}>
          <p style={{ maxWidth: 800, margin: "0 auto" }}>
            <strong>Not sure where to start?</strong> Follow our guided
            paths—structured journeys that walk you through Ory's products and
            solutions so you can learn and build faster.
          </p>
        </div>
            ...
            <div className="col col--4" key={index}>
              <div className="card" style={{ height: "100%" }}>
                {index === 0 && (
                  <div className="card__header">
                    <p style={{ fontSize: "0.85rem", marginBottom: "0.5rem" }}>
                      <strong>
                        Want to learn more about a specific product suite or
                        solution?
                      </strong>{" "}
                      Go directly to product and solution specific information.
                    </p>
                  </div>
                )}
                {index === 1 && (
                  <div className="card__header">
                    <p style={{ fontSize: "0.85rem", marginBottom: "0.5rem" }}>
                      <strong>Want to start coding and need an example?</strong>{" "}
                      Take a look in the Quickstarts to find the framework and
                ...
                {index === 2 && (
                  <div className="card__header">
                    <p style={{ fontSize: "0.85rem", marginBottom: "0.5rem" }}>
                      <strong>Want to find the right API to use?</strong> Go
                      directly to the REST API, SDKs, or CLI references.
                    </p>
                  </div>
                )}
                {index === 0 && (
                  <div className="card__footer">
                    <p>
                      Click on
                      <Link to="/products/products-overview">
                        <strong> Products</strong>
                      </Link>{" "}
                      or{" "}
                      <Link to="/solutions/solutions-overview">
                ...
                {index === 2 && (
                  <div className="card__footer">
                    <p>
                      Click on
                      <Link to="/reference/reference-overview">
        ...
        <div className="row" style={{ marginTop: "2rem" }}>
          <div className="col col--12">
            ...
            <p style={{ fontSize: "1rem", marginBottom: "1rem" }}>
              Choose the deployment option that fits your organization and build
              secure IAM into your apps. You can switch later — the core
      ...
      <div className="container">
        <div className="row margin-bottom--sm">
          <div className="col col--8">
            <h2>Other guides</h2>
            <p style={{ maxWidth: 560 }}>
              Opinionated, end-to-end walkthroughs to help you ship real
              features, not just hello-world demos.
            </p>
          </div>
        </div>
