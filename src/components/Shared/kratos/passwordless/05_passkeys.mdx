...
<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/embed/SWocv4BhCNg"
  frameBorder="0"
  allowFullScreen
/>
...
By default, the passkey strategy is disabled. Go to

<ConsoleLink route="project.passwordless" /> and toggle the switch for **Enable Passkey
...
See <SameDeploymentLink to="kratos/passwordless/passkeys-mobile">Implementing
passkeys for web and mobile</SameDeploymentLink> for detailed implementation
...
<ConsoleLink route="project.passwordless" /> and toggle the switch to enable the
feature.
...
See <SameDeploymentLink to="kratos/mfa/webauthn-fido-yubikey">Multi-factor with
WebAuthn</SameDeploymentLink> to learn more.
