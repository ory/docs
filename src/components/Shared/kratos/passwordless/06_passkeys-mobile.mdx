...
See the <SameDeploymentLink to="kratos/passwordless/passkeys">Passkeys
overview</SameDeploymentLink> for initial setup instructions.
...
Review the <SameDeploymentLink to="kratos/passwordless/passkeys">Passkeys
overview</SameDeploymentLink> for configuration options. See
