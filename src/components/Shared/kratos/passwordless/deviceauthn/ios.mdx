...
See <SameDeploymentLink to="kratos/passwordless/deviceauthn">PIN
enrollment</SameDeploymentLink> for the payload reference. To wire the
...
See the <SameDeploymentLink to="kratos/passwordless/deviceauthn">configuration
reference</SameDeploymentLink> for the `ios_biometric_first_factor` opt-in that
biometric first-factor login on iOS also requires.
