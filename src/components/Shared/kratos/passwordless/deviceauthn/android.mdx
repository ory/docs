...
- Read
  <SameDeploymentLink to="kratos/passwordless/deviceauthn#client-implementation-requirements">
...
- Create the signing key **with** `setUserAuthenticationRequired(true)` and
  ...
  <SameDeploymentLink to="kratos/passwordless/deviceauthn#biometric-enrollment">
...
3. Submit the `rotate_secret` payload with `client_key_id`, the fresh
   ...
   <SameDeploymentLink to="kratos/passwordless/deviceauthn#rotating-the-pin-secret">
...
- See
  <SameDeploymentLink to="kratos/passwordless/deviceauthn#protocol-reference">
    Protocol reference
  </SameDeploymentLink>
...
1. **Enroll**
   (<SameDeploymentLink to="kratos/passwordless/deviceauthn#pin-enrollment">PIN
...
2. **Log in**
   (<SameDeploymentLink to="kratos/passwordless/deviceauthn#first-factor-login">First-factor
...
3. **Rotate**
   (<SameDeploymentLink to="kratos/passwordless/deviceauthn#rotating-the-pin-secret">Rotating
...
- See
  <SameDeploymentLink to="kratos/passwordless/deviceauthn#relaxed-attestation-for-testing">
