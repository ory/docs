...
Read the <SameDeploymentLink to="kratos/mfa/step-up-authentication">step-up
...
Read <SameDeploymentLink to="kratos/mfa/totp">Time-based one-time passwords
...
Read <SameDeploymentLink to="kratos/mfa/webauthn-fido-yubikey">WebAuthn and
FIDO2 (YubiKey)</SameDeploymentLink> to learn more.
...
Read <SameDeploymentLink to="kratos/mfa/lookup-secrets">Lookup Secrets (Recovery
...
Read the <SameDeploymentLink to="kratos/mfa/mfa-via-sms">Code via
SMS</SameDeploymentLink> documentation to learn more.
...
Enabling <SameDeploymentLink to="kratos/passwordless/passkeys">passwordless
