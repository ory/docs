...
[cloud architecture best practices](/docs/oss/software-architecture-philosophy). It implements mechanisms that allow handling
...
the Ory documentation. Read [more here](/docs/network/kratos/quickstarts/identity_model) to learn more about identities in Ory.
...
- One [identity schema](/docs/kratos/manage-identities/identity-schema) doesn't fit all - you may have customers that need a billing
...
session states securely. [Read more about it here](/docs/security-model)

### Native and browser APIs

Integrate seamlessly with mobile or native apps and web browsers using robust APIs. Read more about it [here](/docs/identities/native-browser).
...
[here](/docs/kratos/manage-identities/overview).
...
[here](/docs/kratos/session-management/overview).
...
design. Read more about it [here](/docs/account-experience).
...
templates. Read more about it [here](/docs/kratos/emails-sms/custom-email-templates).
...
Read more about the Ory Identities [security model](/docs/security-model) and try out one of the
[Ory Network Identities quickstart guides](/docs/getting-started/overview) for your framework or programming language to learn
