...
Read [more here](@site/docs/network/kratos/quickstarts/01_overview.mdx) to learn more
...
- One [identity schema](@site/docs/kratos/manage-identities/05_identity-schema.mdx) doesn't
...
authentication. Read more about it [here](@site/docs/kratos/concepts/credentials.mdx).
...
Read more about the Ory Identities [security model](@site/docs/security-model.mdx) and
try out one of the
[Ory Network Identities quickstart guides](@site/docs/getting-started/overview.mdx) for
