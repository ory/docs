...
Head over to the [Self-Service Flows Chapter](/docs/kratos/self-service) for an
...
[Step-by-step guides](/docs/kratos/social-signin/overview) to add sign up and
...
take a look at this document: [Hooks](/docs/kratos/hooks/configure-hooks).
...
Have a look at the
[reference configuration](/docs/kratos/reference/configuration) for further
