...
active Ory Session. That route is protected — visiting it without an active session redirects you to the login page.
...
Hit "submit" and open MailSlurper to retrieve the account recovery message. Recovery uses a one-time code (Ory's recommended
practice — codes are phishing-resistant compared to magic links):
