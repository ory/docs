...
about the different set up possibilities in the [Getting Cookies to Work on Multi-Domains Guide](/docs/kratos/guides/multi-domain-cookies).
...
Head over to the [Self-Service Flows Chapter](/docs/kratos/self-service) for an in-depth explanation of how each individual flow works.
...
[Step-by-step guides](/docs/kratos/social-signin/overview) to add sign up and login with popular OIDC providers to the Ory Kratos Quickstart,
for example:
...
Have a look at the [reference configuration](/docs/kratos/reference/configuration) for further information on possible configuration
options.
