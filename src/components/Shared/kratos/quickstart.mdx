...
the active Ory Session. That route is protected — visiting it without an active
session redirects you to the login page.
...
Recovery uses a one-time code (Ory's recommended practice — codes are
phishing-resistant compared to magic links):
