...
[Getting Cookies to Work on Multi-Domains Guide](../../../../docs/kratos/guides/multi-domain-cookies).
...
everything, consider signing up to [Ory Network](https://console.orystg.com/).
...
Head over to the
[Self-Service Flows Chapter](../../../../docs/kratos/self-service) for an
in-depth explanation of how each individual flow works.
...
[Email and Phone Verification and Account Activation Documentation](../../../../docs/kratos/self-service/flows/verify-email-account-activation).
...
[Account Recovery Documentation](../../../../docs/kratos/self-service/flows/account-recovery-password-reset).
...
[Step-by-step guides](../../../../docs/kratos/social-signin/overview) to add
sign up and login with popular OIDC providers to the Ory Kratos Quickstart, for
example:

- [GitHub](../../../../docs/kratos/social-signin/github)
- [Google](../../../../docs/kratos/social-signin/google)
- [Facebook](../../../../docs/kratos/social-signin/facebook)
...
[Hooks](../../../../docs/kratos/hooks/configure-hooks).
...
Have a look at the
[reference configuration](../../../../docs/kratos/reference/configuration) for
