...
For the service quickstart head over to the [service quickstart](/docs/polis/guides/service) documentation.
...
For the NPM quickstart head over to the [NPM quickstart](/docs/polis/guides/npm-library) documentation.
