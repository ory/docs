...
- REST API which serves the
  [Access Control Decision API](@site/docs/oathkeeper/index.mdx#access-control-decision-api)
  as well as other API endpoints such as health checks, JSON Web Key Sets, and a
