...
- [reverse proxy](/docs/oel/oathkeeper#reverse-proxy)
- REST API which serves the
  [Access Control Decision API](/docs/oel/oathkeeper#access-control-decision-api)
...
[installed in a variety of ways](/docs/oathkeeper/install).
...
[configuration chapter](/docs/oathkeeper/reference/configuration).
