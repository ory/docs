...
This example assumes there is a [namespace](/docs/keto/concepts/namespaces)
...
[objects](/docs/keto/concepts/objects) (file IDs) with the owner `demeter` by
using the [list-API](/docs/keto/concepts/api-overview#list-relationships). The
...
[write-API request](/docs/keto/concepts/api-overview#write-apis) adding the
...
[expand-API](/docs/keto/concepts/api-overview#expand-subject-sets) to compile a
...
uses the [check-API](/docs/keto/concepts/api-overview#check-relationships) to
