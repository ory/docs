...
The data model used by Ory Permissions are so-called [relationships](/docs/keto/concepts/relation-tuples) that encode relations
between [subjects](/docs/keto/concepts/subjects) and [objects](/docs/keto/concepts/objects).

:::tip

Read the dedicated documents to learn more about [subjects](/docs/keto/concepts/subjects) and
...
[Ory Permission Language](/docs/keto/reference/ory-permission-language) (OPL). You can then run fine-grained checks against Ory
...
- Learn [what a permission model is and how to create one](/docs/keto/modeling/create-permission-model).
- Read the Ory Permission Language [specification](/docs/keto/reference/ory-permission-language).
