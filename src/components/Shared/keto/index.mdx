...
- Be tech-stack agnostic and use Ory Network [SDKs](/docs/keto/sdk/overview) available for all major programming languages.
...
- Complete the Ory Permissions [quickstart](/docs/network/keto/quickstarts/overview) to see the system in action.
- Learn about the foundational concepts behind Ory Permissions: [relationships](/docs/keto/concepts/relation-tuples),
  [namespaces](/docs/keto/concepts/namespaces), [objects](/docs/keto/concepts/objects), and [subjects](/docs/keto/concepts/subjects).
- Learn [what is a permission model and how to create one](/docs/keto/modeling/create-permission-model).
