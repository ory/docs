...
In this quickstart, you will set up Ory Hydra OAuth2 & OpenID Connect Server and
an exemplary User Login & Consent App using Docker Compose. You need to have the
latest [Docker](https://www.docker.com) and
[Docker Compose](https://docs.docker.com/compose) version and Git installed, as
well as [`jq`](https://stedolan.github.io/jq/download/).

You do not want to self-host? Try
[out common OAuth2 grants on the fully managed version of Ory Hydra](/docs/network/hydra/quickstarts/ory-network-oauth2).
...
Have a look at the
[reference configuration](/docs/self-hosted/oel/oauth2/configuration) for
