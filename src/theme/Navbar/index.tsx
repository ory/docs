  ...
  return (
    <div className="w-full">
      <div className="mx-auto max-w-[1920px] h-16 px-2 flex items-center">
        ...
        <div className="h-full flex items-center border-r border-ory-border-primary px-4 min-[1271px]:hidden">
        ...
        <div className="flex-1 min-w-0 h-full flex items-center gap-2 px-4 lg:px-8">
          ...
          <div className="hidden min-[1271px]:flex min-w-0 items-center gap-2">
            <NavbarItems items={leftItems} />
          </div>

          <div className="ml-auto flex items-center gap-2 min-w-0">
            {/* Right-side items from config (e.g. GitHub, Support dropdown) */}
            <div className="hidden min-[1271px]:flex items-center gap-2">
