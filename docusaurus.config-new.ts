...
// import productLinePlugin from './src/plugins/productLinePlugin'
...
const config: Config = {
  ...
  plugins: [
    ...
    // KEEP YOUR ORIGINAL DOCS PLUGIN (default instance)
    [
    ...
    // Network instance (uses "Ory Identities", "Ory OAuth2", etc.)
    [
      "@docusaurus/plugin-content-docs",
      {
        id: 'network',
    ...
    // OEL instance (uses "Ory Kratos", "Ory Hydra", etc.)
    [
      "@docusaurus/plugin-content-docs",
      {
        id: 'oel',
        path: "docs",
        routeBasePath: "oel",
        sidebarPath: require.resolve("./sidebars-oel.ts"),
        editUrl: `https://github.com/ory/docs/edit/master`,
        showLastUpdateAuthor: true,
        showLastUpdateTime: true,
        disableVersioning: false,
    ...
    // OSS instance (uses "Ory Kratos", "Ory Hydra", etc.)
    [
      "@docusaurus/plugin-content-docs",
      {
        id: 'oss',
        path: "docs",
        routeBasePath: "oss",
        sidebarPath: require.resolve("./sidebars-oss.ts"),
        editUrl: `https://github.com/ory/docs/edit/master`,
        showLastUpdateAuthor: true,
        showLastUpdateTime: true,
        disableVersioning: false,
