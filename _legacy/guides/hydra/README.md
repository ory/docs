...
1. Hydra is not something that manages user accounts. Hydra does not offer user registration, password reset, user
   ...
   The communication between Hydra and the Identity Provider is called [_Login and Consent Flow_](https://www.ory.sh/docs/guides/master/hydra/3-overview/1-oauth2#implementing-a-login--consent-provider).
