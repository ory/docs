...
What conditions you can use and how you use is documented
[here](./5-conditions). Since that requires knowledge of the Warden API works,
let's look at that first in the [next chapter](./2-warden).
