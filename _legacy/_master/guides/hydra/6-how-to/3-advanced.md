...
ORY Hydra supports JSON Web Tokens as Access Tokens. We _discourage you from
using this feature for multiple reasons:_
...
If you still want to use this strategy you can do so by setting environment
variable `OAUTH2_ACCESS_TOKEN_STRATEGY=jwt`.
