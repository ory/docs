...
`docker exec -it hydra_hydra_1 \` completely.
...
[Securing ORY Hydra](../2-environment/securing-ory-hydra.md). If you want to run
ORY Hydra admin and public services in two separate containers, run
...
the CLI locally and omit `docker exec -it hydra_hydra_1 \` from your commands.
